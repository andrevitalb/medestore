...
<html lang="es">
	<head>
		...
		<meta
			content="http://www.medestore.mx/assets/img/facebook-thumbnails/plapen-facebook.png"
			property="og:image"
		/>
		<meta
			content="Equipo de tratamientos con plasma. Atenúa arrugas y cicatrices, esteriliza la piel y combate bacterias que causan problemas a la piel."
		...
		<meta
			name="twitter:image"
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/plapen-facebook.png"
		/>
	...
	<body>
		...
		<div class="ms-site-container">
			...
			<div id="wrapper">
				<div
					id="home-stage"
					class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full plapen-bg section"
				>
									...
									<div class="son-div">
										<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
											<figure class="logo-product">
												<img
													src="assets/img/products/plapen/logo-Plapen-dual-white.png"
													alt="Logotipo de Plapen dual"
													class="img-fluid"
												/>
											</figure>
										</span>
										...
										>
											Equipo de <strong>tratamiento con Plasma</strong>
										</h2>
								...
								<div class="col-md-6">
									<div class="center-block mt-2 animated zoomInDown animation-delay-8">
										<figure class="stage-product">
											<img
												src="assets/img/products/plapen/Plapen-dual-equipo.png"
												alt="Equipo Plapen dual"
												class="img-fluid"
											/>
										</figure>
									</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								>
									<strong class="color-primary-plapen">Plapen dual</strong> utiliza moléculas de
									aire como medio para transformarse instantáneamente en una intensa energía para
									influir en el enlace iónico de moléculas y átomos con el fin de producir una forma
									concentrada de plasma.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/plapen/pieza-de-mano-plapen02.png"
										alt="Pieza de mano del equipo Plapen dual"
										class="img-fluid"
									/>
								</figure>
							</div>
              ...
              <p class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4 color-primary-coolshaping2"><strong>Criolipólisis</strong> es una nueva tecnología no invasiva, trabaja con la exposición de enfriamiento conducido, de forma selectiva y gradual, a la reducción de la grasa subcutánea en diferentes áreas del cuerpo.</p>
				...
				>
					<div class="container">
						<div class="row">
							<div id="full-ultracel" class="col-md-3 text-center">
								<figure>
									<img
										src="assets/img/products/plapen/Plapen-dual-equipo-full.png"
										alt="Equipo Plapen dual"
										class="img-fluid"
									/>
								</figure>
							...
							<div class="col-md-9 father-div">
								<div class="son-div">
									<h3 class="color-white mb-2 fadeInDown animation-delay-5">
										¿Por qué <strong class="color-white">Plapen dual</strong>?
									</h3>
									<p>
										<strong>Plapen dual</strong> mejora la piel y enfermedades cutáneas con dos
										tipos de piezas de mano y 4 tipos de punta.
									</p>
                  ...
                  <li>Eliminacion de milia</li>
									...
									<p class="text-white">
										Elimina eficazmente bacterias causantes de problemas de la piel, como el acné.
									</p>
									...
									<p class="text-white">
										Efecto de sublimación en la piel sin afectar las células.
									</p>
									<h6 class="color-white">Eliminación de imperfecciones y manchas</h6>
									<p class="text-white">
										Efecto anti-pigmentación mediante la supresión de la melanina.
									</p>
								</div>
							</div>
						</div>
								...
								<div class="media">
									<div class="media-left media-middle">
										<a href="javascript:void(0)">
											<img
												class="media-object media-object-circle"
												src="assets/img/products/plapen/sublimacion-plapen.png"
												alt="..."
											/>
										</a>
									</div>
									<div class="media-body">
										...
										<p>
											Eficaz para tratar acné y cicatrices provocando sublimación en la superficie
											de la piel sin afectar las células.
										</p>
									</div>
								</div>
							</div>
								...
								<div class="media">
									<div class="media-left media-middle">
										<a href="javascript:void(0)">
											<img
												class="media-object media-object-circle"
												src="assets/img/products/plapen/arrugas-plapen.png"
												alt="..."
											/>
										</a>
									</div>
									<div class="media-body">
										...
										<p>
											No ablativo, lifting, regenerador, tratamiento de cicatrices e inflamación.
										</p>
									</div>
								</div>
							</div>
								...
								<div class="media">
									<div class="media-left media-middle">
										<a href="javascript:void(0)">
											<img
												class="media-object media-object-circle"
												src="assets/img/products/plapen/tersante-plapen.png"
												alt="..."
											/>
										</a>
									</div>
									<div class="media-body">
										...
										<p>
											Anti-pigmentación mediante la supresión del pigmento de melanina y el
											fortalecimiento de la absorción de los cosméticos anti-pigmentación.
										</p>
									</div>
								</div>
							</div>
								...
								<div class="media">
									<div class="media-left media-middle">
										<a href="javascript:void(0)">
											<img
												class="media-object media-object-circle"
												src="assets/img/products/plapen/esterilizacion-plapen.png"
												alt="..."
											/>
										</a>
									</div>
									<div class="media-body">
										...
										<p>
											Esteriliza bacterias causantes de problemas en la piel con su poder
											purificante.
										</p>
									</div>
								</div>
								...
								<div class="media">
									<div class="media-left media-middle">
										<a href="javascript:void(0)">
											<img
												class="media-object media-object-circle"
												src="assets/img/products/plapen/transdermal-plapen.png"
												alt="..."
											/>
										</a>
									</div>
									<div class="media-body">
										...
										<p>
											Induce una absorción asombrosa, rompiendo las moléculas de adhesión celular
											(CAMs) que conectan células cutáneas.
										</p>
									</div>
								</div>
							</div>
								...
								<div class="media">
									<div class="media-left media-middle">
										<a href="javascript:void(0)">
											<img
												class="media-object media-object-circle"
												src="assets/img/products/plapen/regeneracion-plapen.png"
												alt="..."
											/>
										</a>
									</div>
									<div class="media-body">
										...
										<p>
											Previene el envejecimiento de la piel al estimular la regeneración de colágeno
											y fibroblastos.
										</p>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<figure class="text-center">
											<img
												src="assets/img/products/plapen/high-frecuency-tip01.png"
												alt="Punta de alta frecuencia PLapen dual"
												class="img-fluid"
											/>
										</figure>
									...
									<div class="col-md-6">
										<figure class="text-center">
											<img
												src="assets/img/products/plapen/high-frecuency02.png"
												alt="Punta de alta frecuencia PLapen dual"
												class="img-fluid"
											/>
										</figure>
							...
							<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<figure class="text-center">
											<img
												src="assets/img/products/plapen/jet-tip01.png"
												alt="Punta de chorro PLapen dual"
												class="img-fluid"
											/>
										</figure>
										<!-- <h6 class="text-center color-primary-coolshaping2"><span class="no-mobile">01 |</span> Crío-enfriamiento</h6> -->
									...
									<div class="col-md-6">
										<figure class="text-center">
											<img
												src="assets/img/products/plapen/jet-tip02.png"
												alt="Punta de chorro PLapen dual"
												class="img-fluid"
											/>
										</figure>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<p
									class="lead text-center aco color-dark fadeInDown animation-delay-6 mw-800 center-block mb-2"
								>
									Se aplica una fuerte ablación en una zona específica de la superficie de la piel
									para tratar las lesiones cutáneas, mientras se genera el plasma de alto voltaje a
						...
						<div class="big-image row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/plapen/Plapen_dual-pen-handpiece.png"
										alt="Pieza de mano de pluma"
										class="img-fluid"
									/>
								</figure>
							</div>
						...
						<div class="row fus-steps mt-2">
							<div class="col-md-4">
								...
								<figure class="text-center">
									<img
										src="assets/img/products/plapen/aguja-bidireccional.png"
							...
							<div class="xs-image col-md-4">
								<h6 class="color-dark"><span class="needle-type">Tipo electrodo</span></h6>
							...
							<div class="xs-image col-md-4">
								<h6 class="color-dark"><span class="round-type">Tipo redondo</span></h6>
								<ul class="round-list">
				...
				<section id="frm-ultracel" class="section bg-plapen-two">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="text-center color-white mb-2 fadeInDown animation-delay-5">
									Pieza de Mano Multi-tip
								</h2>
								...
								>
									Se utiliza en el cuidado de la piel como un eficiente bactericida y solución
									osmótica contra: Estafilococo dorado, (bacteria del acné) tras generación de iones
									plasmáticos.
								</p>
							</div>
						</div>
						<div class="big-image row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/plapen/Plapen_dual-multi-handpiece.png"
										alt="Pieza de mano Multi"
										class="img-fluid"
									/>
								</figure>
							</div>
              ...
              <h4 class="text-center color-white text-light mb-2 fadeInDown animation-delay-5">Terapia en Multi-capas</h4>
						...
						<div class="row mt-2">
							<div class="col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/plapen/handpiece-multi01.png"
										alt="Liberación de iones de plasma Plapen dual"
										class="img-fluid"
									/>
								</figure>
							...
							<div class="col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/plapen/handpiece-multi02.png"
										alt="Liberación de iones Plapen dual"
										class="img-fluid"
									/>
								</figure>
								<h6 class="color-white text-center">Punta de Aspersión</h6>
								<p class="text-center color-white">
									Aplicable para tipos de piel divergentes, ya que el punto de micro-solidificación
									se crea tan pronto como se liberan los iones de plasma.
								</p>
							</div>
							<div class="col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/plapen/handpiece-multi03.png"
										alt="Tratamiento de frotación con plasma Plapen dual"
										class="img-fluid"
									/>
								</figure>
								<h6 class="color-white text-center">Punta Fraccionada</h6>
								<p class="text-center color-white">
									Tratamiento de plasma sencillo por fricción que genera plasma térmico.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<p class="destacado">
									Con <strong>Plapen dual</strong> obtendrás los mejores resultados en tratamientos
									reductivos.
								</p>
							</div>
						</div>
									...
									<li>
										<div class="row">
												...
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_1.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento de Acné con Plapen dual"
															>
																<img
																	src="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_1-thumb.jpg"
																	alt="Tratamiento de Acné con Plapen dual"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-8 col-12">
												<p>
													<strong>Tratamiento de acné</strong
													><!-- <br><strong>Observaciones: 1 sesión </strong> -->
												</p>
											</div>
										</div>
									</li>
									<li>
										<div class="row">
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_3.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento de Acné con Plapen dual"
															>
																<img
																	src="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_3-thumb.jpg"
																	alt="Tratamiento de Acné con Plapen dual"
																	class="img-fluid"
																/>
															</a>
											...
											<div class="col-md-8">
												<p>
													<strong>Tratamiento de acné</strong
													><!-- <br><strong>Observaciones: 7 sesiones </strong> -->
												</p>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_2.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento de Acné con Plapen dual"
															>
																<img
																	src="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_2-thumb.jpg"
																	alt="Tratamiento de Acné con Plapen dual"
																	class="img-fluid"
																/>
															</a>
											...
											<div class="col-md-8">
												<p>
													<strong>Tratamiento de acné</strong
													><!-- <br><strong>Observaciones: 5 sesiones</strong> -->
												</p>
											</div>
										</div>
									</li>
									<li>
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_4.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento de Contorno de ojos con Plapen dual"
															>
																<img
																	src="assets/img/casos-clinicos/plapen/CasoClinico_Plapen_4-thumb.jpg"
																	alt="Tratamiento de Contorno de ojos con Plapen dual"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-8 no-mobile">
												<p>
													<strong>Contorno de ojos</strong
						...
						<div class="row">
							<div class="col-md-7 col-12">
								<div class="title-data-sheet">
									<figure class="logo-product">
										<img
											src="assets/img/products/plapen/logo-Plapen-dual-color.png"
											alt="Logotipo de Plapen dual"
											class="img-fluid"
										/>
									</figure>
									...
									<table class="table table-responsive">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													Punta de Alta frecuencia, Punta de aspersión, Punta Fraccional<br />Punta
													tipo Electrodo (0.5Ø, 30mm)
												</td>
											</tr>
										</tbody>
									</table>
								...
								<div class="download-brochure">
									<a
										href="assets/brochures/brochure-Plapen-dual.pdf"
