...
if ($recaptcha->score >= 0.7) {
		...
		if ($state == 'Ciudad de México' || $state == 'Estado de México') {
			...
			switch ($maxInd[0] % 4) {
				...
				case 2:
					...
					break;
				case 3:
					$distName = "Lourdes Rivero Valdez";
	...
	if ($distName != "Medestore") $headers .= 'Cc: ventas.medestore@medestore.odoo.com, contacto@medestore.mx, leadsmedestore@gmail.com' . "\r\n";
	else $headers .= 'Cc: ventas.medestore@medestore.odoo.com, leadsmedestore@gmail.com' . "\r\n";
