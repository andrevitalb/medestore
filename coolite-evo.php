...
<head>
  ...
  <!-- METAS FACEBOOK -->
  <meta content='Coolite EVO' property='og:title' />
  <meta content='http://www.medestore.mx/assets/img/facebook-thumbnails/generic/equipos/coolite-evo-facebook.png' property='og:image' />
  <meta content='La nueva generación de Láser Diodo para tratamimentos de depilación y rejuvenecimiento facial.' property='og:description' />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="http://www.medestore.mx/coolite-evo.php">
  <meta property="og:image:type" content="image/png">
  <!-- METAS TWITTER -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:site" content="@medestoremx">
  <meta name="twitter:creator" content="@medestoremx">
  <meta name="twitter:title" content="Coolite EVO">
  <meta name="twitter:description" content="La nueva generación de Láser Diodo para tratamimentos de depilación y rejuvenecimiento facial.">
  <meta name="twitter:image" content="https://www.medestore.mx/assets/img/facebook-thumbnails/facebook-thumbnails/generic/equipos/coolite-evo-facebook.png">
  <title>MedeStore | Coolite EVO</title>
  <meta name="description" content="La nueva generación de Láser Diodo para tratamimentos de depilación y rejuvenecimiento facial.">
...
<body>
  ...
  <div class="ms-site-container">
    ...
    <div id="wrapper">
      <div id="home-stage" class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full coolite-bg section">
                ...
                <div class="son-div">
                  <span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
                    <figure class="logo-product">
                      <img src="assets/img/products/coolite-evo/logo-coolite-evo-white.png" alt="Logotipo de Coolite EVO" class="img-fluid">
                    </figure>
                  </span>
                  <h2 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7">Evoluciona tu<strong> piel ahora</strong></h2>
              ...
              <div class="col-md-6">
                <div class="center-block mt-2 animated zoomInDown animation-delay-8">
                  <figure class="stage-product">
                    <img src="assets/img/products/coolite-evo/coolite-evo-stage.png" alt="Equipo Coolite EVO" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h2 class="text-center color-primary-coolite mb-2 "><span class="color-dark">Coolite</span> EVO</h2>
              <h4 class="text-center color-secondary-coolite text-light fadeInDown animation-delay-5">La evolución de Coolite PRO</h4>
              <h4 class="text-center color-secondary-coolite text-light mb-2 fadeInDown animation-delay-5">La nueva generación de Láser Diodo</h4>

              <p class="lead text-center aco fadeInDown animation-delay-6 mw-900 center-block mb-4">Con una larga vida útil en tratamientos de depilación y su nuevo sistema de rejuvenecimiento, <strong>Coolite Evo</strong> ofrece mayor retorno de inversión. <br>Gracias a la potencia de láser mejorada y al tamaño de disparo más grande, los pacientes experimentarán tratamientos mucho más rápidos y cómodos.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 text-center">
              <figure>
                <img src="assets/img/products/coolite-evo/Coolite-EVO-Handle.png" alt="Pieza de mano del equipo Coolite EVO" class="img-fluid">
              </figure>
            </div>
          </div>
      ...
      <section id="funcionamiento-coolite" class="section ms-hero-img-room color-white intro-hero-full">
        <div class="container-fluid">
          <div class="row">
            <div id="full-ultracel" class="col-md-3 offset-md-1 text-center father-div">
              <figure class="son-div">
                <img src="assets/img/products/coolite-evo/coolite-EVO-full.png" alt="Equipo Coolite EVO" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-6 father-div">
              <div class="son-div">
                <h3 class="color-white mb-2 fadeInDown animation-delay-5">¿Por qué <strong class="color-primary-coolite">Coolite EVO</strong>?</h3>
                
                <h6 class="color-secondary-coolite">Nuevo software para rejuvenecimiento de la piel</h6>
                <p class="text-white">Coolite Evo es la primera versión de la familia Coolite con un software adicional para el rejuvenecimiento de la piel, mejora enormemente el ROI del equipo. Reduce poros agrandados, da brillo y reafirma la piel.</p>
                <h6 class="color-secondary-coolite">Potencia láser mejorada, tamaño de punto más grande</h6>
                <p class="text-white">La potencia del láser se mejora en un 20%, hasta 750 W, lo que brinda un tratamiento más cómodo para el paciente. El tamaño del punto se incrementa a 10 mm x 15 mm, lo que reduce significativamente el tiempo de tratamiento.</p>
                <h6 class="color-secondary-coolite">Pieza de mano más ligera (pesa solo 210 g)</h6>
                <p class="text-white">La nueva pieza de mano es más ligera ya que se reduce un 30% comparado con el Coolite Pro. Con esta pieza de mano fácil de usar, los especialistas podrán tener una experiencia de trabajo más agradable.</p>
                <h6 class="color-secondary-coolite">2 años de garantía, sin limitación de pulsos</h6>
                <p class="text-white">Coolite Evo ofrece 2 años de garantía, sin limitación de pulso. Este es un gran avance en la historia del láser diodo. Es completamente apto para trabajos pesados y entorno de trabajos hostiles. No aplica en consumibles.</p>
      ...
      <section id="ventajas-coolshaping2" class="section">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-center color-primary-coolite mb-2 ">VENTAJAS</h2>
          ...
          <div class="row fus-steps mt-2">
            <div class="col-md-2 offset-md-1">
              <figure class="text-center redondear">
                <img src="assets/img/products/coolite-evo/enfriamiento-coolite-EVO.jpg" alt="Crío-energía estable COOLshaping 2" class="img-fluid">
              </figure>
              <h6 class="text-center color-primary-coolite"><span>Enfriamiento<br>por contacto</h6>

            </div>
            <div class="col-md-2">
              <figure class="text-center redondear">
                <img src="assets/img/products/coolite-evo/potencia-coolite.png" alt="Varias piezas de mano COOLshaping 2" class="img-fluid">
              </figure>
              <h6 class="text-center color-primary-coolite"><span >Mayor<br>potencia láser</h6>

            </div>
            <div class="col-md-2">
              <figure class="text-center redondear">
                <img src="assets/img/products/coolite-evo/mayor-vida-util-coolite-EVO.jpg" alt="Sin tiempo de inactividad COOLshaping 2" class="img-fluid">
              </figure>
              <h6 class="text-center color-primary-coolite"><span>Mayor<br>vida útil</h6>

            </div>
            <div class="col-md-2">
              <figure class="text-center redondear">
                <img src="assets/img/products/coolite-evo/handpiece-ligera-coolite-EVO.jpg" alt="Pulso de Vacuum variable COOLshaping 2" class="img-fluid">
              </figure>
              <h6 class="text-center color-primary-coolite"><span >Pieza de mano<br>más ligera</h6>

            </div>
            <div class="col-md-2">
              <figure class="text-center redondear">
                <img src="assets/img/products/coolite-evo/rejuvenecimiento-piel-coolite-EVO.jpg" alt="Interfaz amigable COOLshaping 2" class="img-fluid">
              </figure>
              <h6 class="text-center color-primary-coolite"><span >Rejuvenecimiento<br>de la piel</h6>
      ...
      <section id="aplicacion-facial-info" class="section">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-center color-primary-coolite mb-2 ">Comparación de Láser Diodo</h2>
              <!-- <h4 class="text-center color-white text-light mb-2 fadeInDown animation-delay-5">Mecanismo del tratamiento</h4> -->
            </div>
          </div>
          <div class="row">
            <div id="aplicaciones" class="col-md-8 offset-md-2 col-12">
              <div class="card">
              <table class="table table-responsive table-bordered text-center no-mobile">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Tipo de Láser</td>
                          <td>Láser no colimado</td>
                          <td>Láser Diodo</td>
                          
                        </tr>
                        <tr>
                          <td>Uniformidad del rayo láser</td>
                          <td>Gran ángulo de divergencia</td>
                          <td>Pequeño ángulo de divergencia</td>
                          
                        </tr>
                        <tr>
                          <td>Posibilidad de daño térmico</td>
                          <td>Alto</td>
                          <td>Bajo</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Posibilidad de condensación</td>
                          <td>Extremadamente alto</td>
                          <td>No</td>
                        </tr>
                        <tr>
                          <td>Requisito de mantenimiento</td>
                          <td>Reemplazo de filtro cada 6 meses</td>
                          <td>Reemplazo de filtro cada 12 meses</td>
                        </tr>
                        <tr>
                          <td>Garantía</td>
                          <td>1 año</td>
                          <td>2 años, sin límite de disparos</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div class="bs-example">
                    <table class="table table-responsive table-bordered text-center no-desktop" style="vertical-align: middle;">
                      <tbody>
                        <tr>
                          <td colspan="2">Tipo de Láser</td>
                        </tr>
                        <tr>
                          <td>Láser no colimado</td>
                          <td style="vertical-align: middle;" class="info-coolite">Láser Diodo</td>
                        </tr>
                        <tr>
                          <td colspan="2">Uniformidad del rayo láser</td>
                        </tr>
                        <tr>
                          <td>Gran ángulo de divergencia</td>
                          <td class="info-coolite">Pequeño ángulo de divergencia</td>
                        </tr><tr>
                          <td colspan="2">Posibilidad de daño térmico</td>
                        </tr>
                        <tr>
                          <td>Alto</td>
                          <td class="info-coolite">Bajo</td>
                        </tr>
                        <tr>
                          <td colspan="2">Enfriamiento de agua</td>
                        </tr>
                        <tr>
                          <td>&lt;30°C</td>
                          <td class="info-coolite">&lt;45°C</td>
                        </tr>
                        <tr>
                          <td colspan="2">Posibilidad de condensación</td>
                        </tr>
                        <tr>
                          <td>Extremadamente alto</td>
                          <td style="vertical-align: middle;" class="info-coolite">No</td>
                        </tr>
                        <tr>
                          <td colspan="2">Requisito de mantenimiento</td>
                        </tr>
                        <tr>
                          <td>Reemplazo de filtro cada 6 meses</td>
                          <td class="info-coolite">Reemplazo de filtro cada 12 meses</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>1 año</td>
                          <td class="info-coolite">2 años, sin límite de disparos</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
          ...
          <div class="row">
            <div class="col-md-7 col-12">
              <div class="title-data-sheet">
                <figure class="logo-product">
                  <img src="assets/img/products/coolite-evo/logo-colite-EVO-color.png" alt="Logotipo de Coolite EVO" class="img-fluid">
                </figure>
              </div>
                ...
                <table class="table table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>&lt;5 °C enfriamiento por contacto de zafiro</td>
                    </tr>
                    <tr>
      ...
      <ul class="ms-slidebar-menu" id="slidebar-menu" role="tablist" aria-multiselectable="true">
        ...
        <li class="card" role="tab" id="sch2">
          ...
          <ul id="sc2" class="card-collapse collapse" role="tabpanel" aria-labelledby="sch2" data-parent="#slidebar-menu">
            ...
            <li>
                <a href="electroporación.html">Electroporación</a>
            </li>
            <li>
