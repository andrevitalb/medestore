...
<html lang="es">
	<head>
		...
		<meta
			content="http://www.medestore.mx/assets/img/facebook-thumbnails/powershape-facebook.png"
			property="og:image"
		/>
		<meta
			content="Sistema integrado para modelado corporal y lifting facial combinado con RF bipolar, multipolar y monopolar térmico, vacuum y láser de bajo nivel"
		...
		<meta
			name="twitter:image"
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/powershape-facebook.png"
		/>
		<title>Medestore | PowerShape 2</title>
		<meta
			name="description"
			content="El mejor equipo con tecnología de Radiofrecuencia, vacuum y láser para modelado corporal y lifting facial."
		/>
	...
	<body>
		...
		<div class="ms-site-container">
			...
			<div id="wrapper">
				<div
					id="home-stage"
					class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full powershape-bg section"
				>
									...
									<div class="son-div">
										<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
											<figure class="logo-product">
												<img
													src="assets/img/products/powershape/logo-powershape.png"
													alt="Logotipo de PowerShape 2"
													class="img-fluid"
												/>
											</figure>
										</span>
										...
										>
											Sistema <br /><strong>multi-funcional</strong> de modelado corporal
										</h2>
								...
								<div class="col-md-6">
									<div class="center-block mt-2 animated zoomInDown animation-delay-8">
										<figure class="stage-product">
											<img
												src="assets/img/products/powershape/stage-powershape.png"
												alt="Equipo PowerShape"
												class="img-fluid"
											/>
										</figure>
									</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<h4
									class="text-center color-secondary-powershape text-light mb-2 fadeInDown animation-delay-5"
								>
									Radiofrecuencia Bi-polar y Multi-polar, Vacuum y Láser de Bajo Nivel
								</h4>

								<p
									class="lead text-center aco fadeInDown animation-delay-6 mw-900 center-block mb-4"
								>
									<strong>PowerShape<sub>2</sub></strong> es un sistema integrado para modelado
									corporal y lifting facial combinado con RF bipolar, multipolar y monopolar
									térmico, vacuum y láser de bajo nivel.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/powershape/disparadores-powershape.jpg"
										alt="Disparadores de PowerShape"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div id="full-ultracel" class="col-md-3 text-center">
								<figure>
									<img
										src="assets/img/products/powershape/powershape-full.png"
										alt="Equipo PowerShape"
										class="img-fluid"
									/>
								</figure>
							...
							<div class="col-md-9 father-div">
								<div class="son-div">
									<h3 class="text-dark mb-2 fadeInDown animation-delay-5">
										¿Por qué <strong class="color-primary-powershape">PowerShape<sub>2</sub></strong
										>?
									</h3>
									<h6 class="color-primary-powershape">1. Radiofrecuencia</h6>
									<p class="color-dark">
										Transmite energía térmica profunda en la capa dérmica, transmitiendo ondas
										electromagnéticas para devolver los procesos fisiológicos con resultado
										efectivos en el tratamiento de la celulitis, modelado corporal y regeneración de
										colágeno mediante radiofrecuencia bipolar y multipolar.
									</p>
									<h6 class="color-primary-powershape">2. Vacuum</h6>
									<p class="color-dark">
										Mejora la circulación sanguínea y unifica la piel para optimizar el suministro
										de energía. El efecto de masaje facilita el drenaje linfático y así modelar el
										cuerpo.
									</p>
									<h6 class="color-primary-powershape">3. Láser de Bajo Nivel</h6>
									<p class="color-dark">
										Longitud de onda de luz (660nm) que licua la grasa para una fácil y eficiente
										eliminación, reduciendo significativamente el tamaño de las células grasas.
									</p>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div id="aplicaciones" class="col-md-6">
								<div id="aplica-facial-info">
									<h3
										class="text-center color-primary-powershape text-light mb-2 fadeInDown animation-delay-5"
									>
										VENTAJAS
									</h3>
							...
							<div id="aplicacion-facial" class="col-md-6">
								<figure>
									<img
										src="assets/img/products/powershape/ventajas-powershape.png"
										alt="Resultados con PowerShape"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<h4
									class="text-center color-secondary-powershape text-light mb-2 fadeInDown animation-delay-5"
								>
									Pieza de mano de rodillo
								</h4>

								<p
									class="lead text-center aco color-dark fadeInDown animation-delay-6 mw-800 center-block mb-2"
								>
									Rodillo de gran tamaño que estira la piel en el área a tratar para mejorar el
									efecto de succión.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/powershape/rodillo-manual-powershape.png"
										alt="Pieza de mano de rodillo de PowerShape"
										class="img-fluid"
									/>
								</figure>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<h4
									class="text-center color-primary-powershape text-light mb-2 fadeInDown animation-delay-5"
								>
									Pieza de mano multi-polar
								</h4>

								<p
									class="lead text-center aco color-primary-powershape fadeInDown animation-delay-6 mw-800 center-block mb-4"
								>
									Tecnología de radiofrecuencia Multi-Polar que emite energía enfocada y óptima a la
									superficie de la piel y a las capas de grasa subcutánea sin causar dolor.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/powershape/multipolar-powershape.png"
										alt="Pieza multipolar de PowerShape"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h4
									class="text-center color-primary-powershape text-light mb-2 fadeInDown animation-delay-5"
								>
									Pieza de mano térmica
								</h4>

								<p
									class="lead text-center aco color-dark fadeInDown animation-delay-6 mw-800 center-block mb-4"
								>
									Al aplicar energía térmica con un método no ablativo, la radiofrecuencia penetra
									profundamente en la dermis, produciendo estimulación de colágeno sin dañar la
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/powershape/termico-powershape.png"
										alt="Pieza de mano térmica de PowerShape"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<p class="destacado">
									Con
									<strong class="color-primary-powershape">PowerShape<sub>2</sub></strong> obtendrás
									los mejores resultados en un menor tiempo en aplicación facial o corporal.
								</p>
							</div>
						</div>
						<!--.row-->
												...
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/powershape/caso_clinico01.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen"
															>
																<img
																	src="assets/img/casos-clinicos/powershape/caso_clinico01_t.jpg"
																	alt="Tratamiento en abdomen con PowerShape"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/powershape/caso_clinico02.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en espalda"
															>
																<img
																	src="assets/img/casos-clinicos/powershape/caso_clinico02_t.jpg"
																	alt="Tratamiento en espalda con PowerShape"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/powershape/caso_clinico03.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen"
															>
																<img
																	src="assets/img/casos-clinicos/powershape/caso_clinico03_t.jpg"
																	alt="Tratamiento en abdomen con PowerShape"
																	class="img-fluid"
																/>
															</a>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/powershape/caso_clinico04.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen"
															>
																<img
																	src="assets/img/casos-clinicos/powershape/caso_clinico04_t.jpg"
																	alt="Tratamiento en abdomen con PowerShape"
																	class="img-fluid"
																/>
															</a>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/powershape/caso_clinico05.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en glúteos"
															>
																<img
																	src="assets/img/casos-clinicos/powershape/caso_clinico05_t.jpg"
																	alt="Tratamiento en glúteos con PowerShape"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/powershape/caso_clinico06.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en papada"
															>
																<img
																	src="assets/img/casos-clinicos/powershape/caso_clinico06_t.jpg"
																	alt="Tratamiento en papada con PowerShape"
																	class="img-fluid"
																/>
															</a>
														</div>
							...
							<div class="offset-md-4 col-md-4">
								...
								<div class="card">
									<div
										...
										data-plyr-embed-id="O53YFPbmSsc"
										class="js-player"
									></div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-7 col-12">
								<div class="title-data-sheet">
									<figure class="logo-product">
										<img
											src="assets/img/products/powershape/logo-PowerShape-color.png"
											alt="Logotipo de PowerShape"
											class="img-fluid"
										/>
									</figure>
								</div>
