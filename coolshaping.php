...
<html lang="es">
	<head>
		...
		<meta
			content="http://www.medestore.mx/assets/img/facebook-thumbnails/coolshaping-facebook.png"
			property="og:image"
		/>
		<meta
			content="El equipo más novedoso para la eliminación de grasa localizada y modelado corporal"
		...
		<meta
			name="twitter:image"
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/coolshaping-facebook.png"
		/>
	...
	<body>
		...
		<div class="ms-site-container">
			...
			<div id="wrapper">
				<div
					id="home-stage"
					class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full coolshaping-bg section"
				>
									...
									<div class="son-div">
										<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
											<figure class="logo-product">
												<img
													src="assets/img/products/coolshaping/logo_header.png"
										...
										>
											Lo más novedoso para la <strong>eliminación</strong> de grasa localizada
										</h2>
								...
								<div class="col-md-6">
									<div class="center-block mt-2 animated zoomInDown animation-delay-8">
										<figure class="stage-product">
											<img
												src="assets/img/products/coolshaping/stage-coolshaping.png"
												alt="Equipo COOLshaping"
												class="img-fluid"
											/>
										</figure>
									</div>
				...
				<section class="section">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<h4
									class="text-center color-secondary-coolshaping text-light mb-2 fadeInDown animation-delay-5"
								>
									Criolipólisis + Vacuum + Led
								</h4>

								<p
									class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4"
								>
									<strong>COOLshaping&trade;</strong> es la solución más avanzada para reducir
									medidas al combinar tres tecnologías en un solo equipo.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/coolshaping/pieza-de-mano-coolshaping.png"
										alt="Pieza de mano del equipo COOLshaping"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row mtop30 mt-4">
							<div class="col-md-12">
								<p
									class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4 color-primary-coolshaping"
								>
									El sistema utiliza <strong>Crío-energía</strong> durante el tratamiento en
									combinación con Vacuum terapia y Led que mejoran los efectos del tratamiento
					...
					<div class="container">
						<div class="row">
							<div id="full-ultracel" class="col-md-3 text-center">
								<figure>
									<img
										src="assets/img/products/coolshaping/full-coolshaping.png"
										alt="Equipo COOLshaping"
										class="img-fluid"
									/>
								</figure>
							...
							<div class="col-md-9 father-div">
								<div class="son-div">
									<h3 class="text-white mb-2 fadeInDown animation-delay-5">
										¿Por qué <strong class="color-secondary-coolshaping">COOLshaping™</strong>?
									</h3>
									<h6 class="color-secondary-coolshaping">1. Sistema totalmente automatizado</h6>
									<p class="text-white">
										<strong>COOLshaping</strong> se encarga de tu paciente mientras tu personal
										atiende otras labores.
									</p>

									<h6 class="color-secondary-coolshaping">2. Mejores resultados en menos tiempo</h6>
									<p class="text-white">
										Utiliza una o las dos piezas de mano incluidas para tratar dos áreas al mismo
										tiempo.
									</p>
									<h6 class="color-secondary-coolshaping">3. Estable y seguro</h6>
									<p class="text-white">
										Emite Crío-energía de forma óptima para la reducción local de las células de
										grasa y modelado corporal, además de que mantiene una temperatura estable
										durante todo el tratamiento.
									</p>
									<h6 class="color-secondary-coolshaping">4. Excelente rentabilidad</h6>
									<p class="text-white">
										No necesita personal para su operación y además el material y mantenimiento
										requerido es mínimo.
									</p>
									<h6 class="color-secondary-coolshaping">5. Multitecnología</h6>
									<p class="text-white">
										Adicional a la Criolipólisis, la Vacuum y el sistema Led generan mejores
										resultados.
									</p>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-3">
								<figure class="text-center">
									<img
										src="assets/img/products/coolshaping/aplicador-mini.png"
										alt="Aplicador mini de COOLshaping"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-coolshaping"><span>Mini (Papada)</span></h6>
							...
							<div class="col-md-3">
								<figure class="text-center">
									<img
										src="assets/img/products/coolshaping/aplicador-chico.png"
										alt="Aplicador chico de COOLshaping"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-coolshaping"><span>Chicas</span></h6>
								<p class="text-center color-secondary-coolshaping">(Opcionales)</p>
							...
							<div class="col-md-3">
								<figure class="text-center">
									<img
										src="assets/img/products/coolshaping/aplicador-mediano.png"
										alt="Aplicador mediano de COOLshaping"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-coolshaping"><span>Medianas</span></h6>
							...
							<div class="col-md-3">
								<figure class="text-center">
									<img
										src="assets/img/products/coolshaping/aplicador-grande.png"
										alt="Aplicador grande de COOLshaping"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-coolshaping"><span>Grandes</span></h6>
								<p class="text-center color-secondary-coolshaping">(Opcionales)</p>
						...
						<div class="row">
							<div id="aplicaciones" class="col-md-6">
								<div id="aplica-facial-info">
									<h3
										class="text-center color-primary-coolshaping text-light mb-2 fadeInDown animation-delay-5"
									>
										APLICACIÓN CORPORAL
									</h3>
							...
							<div id="aplicacion-facial" class="col-md-6">
								<figure>
									<img
										src="assets/img/products/coolshaping/aplicacion-coolshaping.png"
										alt="Resultados de modelado corporal con COOLshaping"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						...
						<div class="row fus-steps mt-2">
							<div class="xs-image col-md-3">
								...
								<h6 class="text-center color-primary-coolshaping">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<p class="destacado">
									Con <strong>COOLshaping</strong> obtendrás los mejores resultados en tratamientos
									reductivos.
								</p>
							</div>
						</div>
								...
								<ul class="clinic-cases-list list-unstyled">
									<li>
										<div class="row">
												...
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_0.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en espalda alta y baja"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_0_t.jpg"
																	alt="Tratamiento en espalda alta y baja con COOLshaping"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-8 col-12 no-mobile">
												<p>
													<strong>Espalda alta y baja</strong><br /><strong>Observaciones: </strong
													>Resultados 8 semanas después del primer tratamiento
												</p>
											</div>
										</div>
									</li>
									<li>
										<div class="row">
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_2.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen y espalda baja"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_2_t.jpg"
																	alt="Tratamiento en abdomen y espalda baja con COOLshaping"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-8 no-mobile">
												<p>
													<strong>Abdomen y espalda baja</strong><br /><strong
														>Observaciones: </strong
													>Resultados 12 semanas después del primer tratamiento
												</p>
											</div>
										</div>
									</li>
									<li>
										<div class="row">
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_4.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en muslos y chaparreras"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_4_t.jpg"
																	alt="Tratamiento en muslos y chaparreras con COOLshaping"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-8 no-mobile">
												<p>
													<strong>Muslos y chaparreras</strong><br /><strong>Observaciones: </strong
													>Resultados 8 semanas después del primer tratamiento
												</p>
											</div>
										</div>
									...
									<li>
										<div class="row">
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_6.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_6_t.jpg"
											...
											<div class="col-md-8 no-mobile">
												<p>
													<strong>Abdomen</strong><br /><strong>Observaciones: </strong>Resultados 8
													semanas después del primer tratamiento
												</p>
											</div>
										</div>
									</li>
								...
								<ul class="clinic-cases-list list-unstyled">
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_1.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_1_t.jpg"
																	alt="Tratamiento en abdomen con COOLshaping"
																	class="img-fluid"
																/>
															</a>
									...
									<li>
										<div class="row">
											...
											<div class="col-md-8 no-mobile">
												<p>
													<strong>Abdomen</strong><br /><strong>Observaciones: </strong>Resultados
									...
									<li>
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_5.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en espalda"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_5_t.jpg"
																	alt="Tratamiento en espalda con COOLshaping"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-8 no-mobile">
												<p>
													<strong>Espalda</strong><br /><strong>Observaciones: </strong>Resultados 8
													semanas después del primer tratamiento
												</p>
											</div>
										</div>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/coolshaping/caso_7.jpg"
																data-lightbox="gallery"
																data-title="Tratamiento en abdomen"
															>
																<img
																	src="assets/img/casos-clinicos/coolshaping/caso_7_t.jpg"
																	alt="Tratamiento en abdomen con COOLshaping"
																	class="img-fluid"
																/>
															</a>
						...
						<div class="row">
							<div class="col-md-4 offset-md-2 col-12">
								...
								<div class="card">
									<div
										...
										data-plyr-embed-id="i8OefuQ1Sog"
										class="js-player"
									></div>
								</div>
							</div>
							...
							<div class="col-md-4 col-12">
								...
								<div class="card">
									<div
										data-plyr-provider="youtube"
										data-plyr-embed-id="ZdXmroYJbV8"
										class="js-player"
									></div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-7 col-12">
								<div class="title-data-sheet">
									<figure class="logo-product">
										<img
											src="assets/img/products/coolshaping/logo_coolshaping.png"
											alt="Logotipo de COOLshaping"
											class="img-fluid"
										/>
									</figure>
									...
									<table class="table table-responsive">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													Pieza de mano grande de 12cm x 22cm x 14cm, <br />Pieza de mano chica de
													10cm x 14cm x 11cm, <br />Pieza de mano mini de 5cm x 8cm x 11cm
												</td>
											</tr>
											<tr>
								...
								<div class="download-brochure">
									<a
										href="assets/brochures/brochure-COOLshaping.pdf"
