...
<head>
  ...
  <meta content='https://www.medestore.mx/assets/img/facebook-thumbnails/intracel-pro-facebook.png' property='og:image' />
  <meta content='El Origen de la Tecnología RF Fraccional con Micro-electrodos. Obtén resultados mucho más notorios, seguros y duraderos con el tratamiento que combina las puntas SRR, FRM y SRT.' />
  ...
  <meta name="twitter:description" content="El Origen de la Tecnología RF Fraccional con Microagujas. Obtén resultados mucho más notorios, seguros y duraderos con el tratamiento que combina las puntas SRR, FRM y SRT.">
  <meta name="twitter:image" content="https://www.medestore.mx/assets/img/facebook-thumbnails/intracel-pro-facebook.png">
  <title>MedeStore | INTRAcel PRO</title>
  <meta name="description" content="El Origen de la Tecnología RF Fraccional con Micro-electrodos. Obtén resultados mucho más notorios, seguros y duraderos con el tratamiento que combina las puntas SRR, FRM y SRT.">
...
<body>
  ...
  <div class="ms-site-container">
    ...
    <div id="wrapper">
      <div id="home-stage" class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full intracel-bg section">
                ...
                <div class="son-div">
                  <span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
                    <figure class="logo-product">
                      <img src="assets/img/products/intracel-pro/logo-intracel_pro-white.png" alt="Logotipo INTRAcel PRO" class="img-fluid">
                    </figure>
                  </span>
                  <h2 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7">Evolución del 1<sup style="text-transform: none;">er</sup> <br>Equipo de <strong>Radiofrecuencia fraccionada</strong> del Mundo</h2>
              ...
              <div class="col-md-6">
                <div class="center-block mt-2 animated zoomInDown animation-delay-8">
                  <figure class="stage-product">
                    <img src="assets/img/products/intracel-pro/INTRAcel_PRO-stage.png" alt="Equipo INTRAcel PRO" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h4 class="text-center color-primary-dark text-light mb-2 fadeInDown animation-delay-5">El Origen de la Tecnología RF Fraccional con Microelectrodos</h4>

              <p class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4"><strong>INTRAcel PRO,</strong> resultados mucho más notorios, seguros y duraderos con el tratamiento que combina las puntas <strong>SRR, FRM</strong> y <strong>SRT</strong>.</p>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="col-md-12">
            <div class="center-block mt-2 animated zoomInDown text-center animation-delay-9">
              <figure>
                <img src="assets/img/products/intracel-pro/handpiece-INTRAcel_PRO.png" alt="Pieza de mano de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
      ...
      <section id="funcionamiento-intracel" class="section ms-hero-img-room color-white intro-hero-full">
        <div class="container">
          <div class="row">
            <div id="" class="col-md-3 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/INTRAcel_Pro-full.png" alt="Equipo INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-9 father-div">
              <div class="son-div">
                <h3 class="text-white mb-2 fadeInDown animation-delay-5">¿Por qué <span class="color-primary-intracel_q">INTRAcel PRO™</span>?</h3>
                <h6 class="color-primary-intracel">1. Sistema de verificación de impedancia en tiempo real</h6>
                <p class="text-white">La medición de impedancia única de INTRAcel PRO permite adaptar la energía a cada paciente para siempre lograr los mismos efectos.</p>
                <h6 class="color-primary-intracel">2. Tratamiento rápido y eficaz</h6>
                <p class="text-white">Sólo una hora es necesaria, durante la cual la sensación en la piel será de calor.</p>
                <h6 class="color-primary-intracel">3. Sin tiempo de recuperación</h6>
                <p class="text-white">Al finalizar el tratamiento, el paciente puede regresar a sus actividades de inmediato</p>
                <h6 class="color-primary-intracel">4. Resultados</h6>
                <p class="text-white">Logra resultados de gran duración para tener una piel más firme, tersa, joven y sana. Se observarán cambios paulatinos a partir de la primera semana.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div id="aplicaciones" class="col-md-6">
              <div id="aplica-facial-info">
                <h3 class="text-center color-primary-intracel text-light mb-2 fadeInDown animation-delay-5">APLICACIÓN FACIAL</h3>
            ...
            <div id="aplicacion-facial" class="col-md-6">
              <figure>
                <img src="assets/img/products/intracel-pro/aplicacion-intracel.png" alt="Aplicación facial con INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="lead text-center aco color-white fadeInDown animation-delay-6 mw-800 center-block mb-2">Para calentar el área dérmica, se irradia energía óptima que va midiendo la resistencia de la piel en tiempo real.</p>
            </div>
          </div>
          ...
          <div class="row fus-steps mt-2">
            <div class="xs-image col-md-4">
              <figure class="text-center">
                <img src="assets/img/products/intracel-pro/MSR-irradiacion.jpg" alt="Irradiación de energía con INTRAcel PRO" class="img-fluid">
              </figure>
            ...
            <div class="xs-image col-md-4">
              <figure class="text-center">
                <img src="assets/img/products/intracel-pro/MSR-monitoreo.jpg" alt="Monitoreo de resistencia de la piel INTRAcel PRO" class="img-fluid">
              </figure>
              <h6 class="text-center color-white"><span class="no-mobile">02 |</span> Monitoreo</h6>
              <p class="text-center color-white text-mobile">Monitoreo de la resistencia de la piel y retroalimentación instantánea.</p>
            </div>
            <div class="xs-image col-md-4">
              <figure class="text-center">
                <img src="assets/img/products/intracel-pro/MSR-irradiacion.jpg" alt="Entrega óptima de energía con INTRAcel PRO" class="img-fluid">
              </figure>
              <h6 class="text-center color-white"><span class="no-mobile">03 |</span> Entrega</h6>
              <p class="text-center color-white text-mobile">Se irradia la energía óptima de acuerdo a la resistencia de la piel.</p>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h4 class="text-center color-primary-intracel text-light mb-2 fadeInDown animation-delay-5">Coadyuvante en el tratamiento de Melasma</h4>

              <p class="lead text-center aco color-primary-intracel fadeInDown animation-delay-6 mw-800 center-block mb-4">Técnica única para tratar el área objetivo (dermis) por medio de la penetración de micro-electrodos de diseño especial que no dañan la epidermis.</p>
            </div>
          </div>
          <div class="big-image row">
            <div class="col-md-12 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/beneficios-tratamiento-melasma-INTRAcel.png" alt="Beneficios INTRAcel PRO en tratamiento de Melasma" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h4 class="text-center color-white text-light mb-2 fadeInDown animation-delay-5">49 agujas no-invasivas</h4>

              <p class="lead text-center aco color-white fadeInDown animation-delay-6 mw-800 center-block mb-4"><strong>BIPOLAR</strong><br>Rejuvenecimiento de las arrugas periorbitales</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/punta-SRR.png" alt="Punta SRR 49 agujas no invasivas de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-6 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/punta-SRR-detail.png" alt="Punta SRR 49 agujas no invasivas de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h4 class="text-center color-primary-intracel text-light mb-2 fadeInDown animation-delay-5">49 agujas aisladas</h4>

              <p class="lead text-center aco color-dark fadeInDown animation-delay-6 mw-800 center-block mb-4"><strong>MONO/BIPOLAR</strong><br>Arrugas / Poros / Acné<br>Arrugas finas / Cicatrices</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/punta-FRM-49agujas.png" alt="Punta FRM 49 agujas no invasivas de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-6 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/punta-FRM-detail.png" alt="Punta FRM 49 agujas no invasivas de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <h4 class="text-center color-white text-light mb-2 fadeInDown animation-delay-5">16 agujas no-aisladas</h4>

              <p class="lead text-center aco color-white fadeInDown animation-delay-6 mw-800 center-block mb-4"><strong>BIPOLAR</strong><br>Enrojecimiento / Pecas<br>Melasma</p>
            </div>
          </div>
          <div class="big-image row">
            <div class="col-md-6 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/punta-SRT-16agujas.png" alt="Punta SRR 49 agujas no invasivas de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-6 text-center">
              <figure>
                <img src="assets/img/products/intracel-pro/punta-SRT-detail.png" alt="Punta SRR 49 agujas no invasivas de INTRAcel PRO" class="img-fluid">
              </figure>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="destacado">Con <strong>INTRAcel PRO</strong> obtendrás los mejores resultados en un menor tiempo en aplicación facial.</p>
            </div>
          </div>
          <!--.row-->
          <div class="row">
                      ...
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/intracel-pro/Caso01.jpg" data-lightbox="gallery" data-title="Tratamiento de acné">
                              <img src="assets/img/casos-clinicos/intracel-pro/Caso01-thumb.jpg" alt="Tratamiento de acné en mejillas con INTRAcel PRO" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/intracel-pro/Caso03.jpg" data-lightbox="gallery" data-title="Tratamiento de acné">
                              <img src="assets/img/casos-clinicos/intracel-pro/Caso03-thumb.jpg" alt="Tratamiento de acné mandíbula con INTRAcel PRO" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/intracel-pro/Caso05.jpg" data-lightbox="gallery" data-title="Tratamiento de estrías">
                              <img src="assets/img/casos-clinicos/intracel-pro/Caso05-thumb.jpg" alt="Tratamiento de estrías con INTRAcel PRO" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/intracel-pro/Caso02.jpg" data-lightbox="gallery" data-title="Tratamiento se acné">
                              <img src="assets/img/casos-clinicos/intracel-pro/Caso02-thumb.jpg" alt="Tratamiento de acné en mejillas con INTRAcel PRO" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/intracel-pro/Caso04.jpg" data-lightbox="gallery" data-title="Tratamiento de acné">
                              <img src="assets/img/casos-clinicos/intracel-pro/Caso04-thumb.jpg" alt="Tratamiento acne en mejillas con INTRAcel PRO" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
          ...
          <div class="row">
            <div class="col-md-4 col-12 offset-md-4">
              <div>
                  <a href="assets/articulos-clinicos/abstract-intracel.pdf" class="btn btn-raised btn-primary btn-brochure" target="_blank">VER ARTÍCULO CLÍNICO</a>
                </div>
            </div>
          </div><!--row-->
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-4 offset-md-4 col-12">
              <h6>INTRAcel PRO</h6>
              <div class="card">
                <div data-plyr-provider="youtube" data-plyr-embed-id="cUXkZU0Ejhk" class="js-player"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-7 col-12">
              <div class="title-data-sheet">
                <figure class="logo-product">
                  <img src="assets/img/products/intracel-pro/logo-intracel_pro-color.png" alt="Logotipo INTRAcel PRO" class="img-fluid">
                </figure>
              </div>
              <div class="data-sheet-contain">
                ...
                <table class="table table-responsive ">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td rowspan="2" valign="middle" class="row-span border-end"><strong>Puntas</strong></td>
              ...
              <div class="download-brochure">
                <a href="assets/brochures/brochure-INTRAcel_PRO.pdf" class="btn btn-raised btn-primary btn-brochure" target="_blank">DESCARGAR FOLLETO</a>
              </div>
            </div>
          </div>
        </div>
