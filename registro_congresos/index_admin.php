<?php session_start();
    ...
    $queryUsers = "Select registros_correo as 'Correo', registros_nombre as 'Nombre', registros_apellido as 'Apellido', registros_telefono as 'Teléfono', registros_especialidad as 'Especialidad', registros_estado as 'Estado' from registros order by registros_ID";
    $resultUsers = mysqli_query($connect, $queryUsers);
    $contUsers = 1;

    $queryCurrent = "Select C.congresos_nombre as 'Nombre Congreso', R.registros_nombre as 'Nombre', R.registros_apellido as 'Apellido', R.registros_correo as 'Correo', R.registros_telefono as 'Telefono', C.congresos_fechaInicio from asistentes as A inner join registros as R on A.asistentes_usuario = R.registros_ID inner join congresos as C on A.asistentes_congreso = C.congresos_ID where congresos_ID = ".$event[0] ." order by A.asistentes_ID";
    $resultCurrent = mysqli_query($connect, $queryCurrent);
    $contCurrent = 1;

    $queryCongress = "Select congresos_nombre as 'Nombre Congreso' from congresos order by congresos_fechaInicio desc";
    $resultCongress = mysqli_query($connect, $queryCongress);

    $queryAssist = "Select C.congresos_nombre as 'Nombre Congreso', R.registros_nombre as 'Nombre', R.registros_apellido as 'Apellido', R.registros_correo as 'Correo', R.registros_telefono as 'Telefono', C.congresos_fechaInicio from asistentes as A inner join registros as R on A.asistentes_usuario = R.registros_ID inner join congresos as C on A.asistentes_congreso = C.congresos_ID order by C.congresos_fechaInicio, A.asistentes_ID";
    $resultAssist = mysqli_query($connect, $queryAssist);
    $contAssist = 1;

    $queryUpdCongress = "Select congresos_nombre as 'Nombre Congreso' from congresos order by congresos_fechaInicio desc";
    $resultUpdCongress = mysqli_query($connect, $queryUpdCongress);

    $queryUpdate = "Select congresos_nombre as 'Nombre Congreso', LEFT(congresos_fechaInicio, 10) as 'Fecha Inicio', LEFT(congresos_fechaFinal, 10) as 'Fecha Final', congresos_titulo as 'Título Evento', congresos_subtitulo as 'Subtítulo Evento', TRIM('#' from congresos_textColor) as 'Color título' from congresos order by congresos_fechaInicio desc";
    $resultUpdate = mysqli_query($connect, $queryUpdate);

    $queryStats = "Select C.congresos_nombre as 'Nombre Congreso', LEFT(C.congresos_fechaInicio, 10) as 'Fecha Inicio', LEFT(C.congresos_fechaFinal, 10) as 'Fecha Final', COUNT(A.asistentes_ID) as 'Número de Asistentes' from asistentes as A inner join congresos as C on A.asistentes_congreso = C.congresos_ID group by C.congresos_nombre order by C.congresos_fechaInicio";
    $resultStats = mysqli_query($connect, $queryStats);
    $contStats = 1;

    $queryContacts = "Select contactos_nombre as Nombre, contactos_apellido as Apellido, contactos_correo as Correo, contactos_telefono as Teléfono, contactos_estado as Estado, contactos_especialidad as Especialidad, contactos_suscrito as Suscrito from contactos order by contactos_ID";
    $resultContacts = mysqli_query($connect2, $queryContacts);
    $contContacts = 1;

    $queryCorea = "Select contactos_nombre as Nombre, contactos_apellido as Apellido, contactos_correo as Correo, contactos_telefono as Teléfono, contactos_estado as Estado, contactos_especialidad as Especialidad, contactos_suscrito as Suscrito from contactocorea order by contactos_ID";
                ...
                <div class="col-lg-12">
                    ...
                    <div class="content-box big-box">
                                ...
                                <select name="select_congreso" id="select_congreso" class="form-control" onchange="showAssists()">
                                    ...
                                    <?php
                                        while($rowCongress = mysqli_fetch_array($resultCongress)){
                                            echo "<option value = '" . $rowCongress[0] . "'>" . $rowCongress[0] . "</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="table-responsive" id = "table_assists">
                            ...
                            <form action="export.php" method = "post" class="caption text-center" style = "margin-top: 1.5rem;">
                                    ...
                                    <select name="select_update" id="select_update" class="form-control" onchange="showUpdate()">
                                        ...
                                        <?php
                                            while($rowUpdate = mysqli_fetch_array($resultUpdCongress)){
                                                echo "<option value = '" . $rowUpdate[0] . "'>" . $rowUpdate[0] . "</option>";
                                            }
                                        ?>
                                    </select>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("#select_congreso").change(function(){
                    ...
                    $("#table_assists input[type='search']").val(filter);
                });
