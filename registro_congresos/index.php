<?php
  ...
  $custom = "Select congresos_background, congresos_textColor, congresos_logo, congresos_nombre, congresos_titulo, congresos_subtitulo from congresos where congresos_ID = $event[0]";
                ...
                <form class="form-horizontal" method = "post">
                  <fieldset>
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" id="register_fname" placeholder="Nombre" name = "register_fname" required> </div>
                    </div>
                    <div class="form-group row">
                      <label for="register_lname" class="col-md-3 control-label">Apellido</label>
                      <div class="col-md-9">
                        <input type="text" class="form-control" id="register_lname" name = "register_lname" placeholder="Apellido" required></div>
                    </div>
                    <div class="form-group row">
                      <label for="register_mail" class="col-md-3 control-label">Email</label>
                      <div class="col-md-9">
                        <input type="email" class="form-control" id="register_mail" name = "register_mail" placeholder="Email" required> </div>
                    </div>
                    <div class="form-group row">
                      <label for="register_phone" class="col-md-3 control-label">Teléfono</label>
                      <div class="col-md-9">
                        <input type="text" class="form-control" id="register_phone" name = "register_phone" placeholder="Teléfono"> </div>
                    </div>
                    <div class="form-group row">
                      <label for="register_specialty" class="col-md-3 control-label">Especialidad</label>
                      <div class="col-md-9">
                        <select id="inputEsp" class="form-control selectpicker" data-live-search="true" data-dropup-auto="false" name = "register_specialty" required>
                    ...
                    <div class="form-group row">
                      <label for="register_state" class="col-md-3 control-label">Estado</label>
                      <div class="col-md-9">
                        <select id="inputState" class="form-control selectpicker" data-live-search="true" data-dropup-auto="false" name = "register_state" required>
                  ...
                  <button class="btn btn-raised btn-primary btn-block" type = "submit" name = "reg_user">REGISTRARME AHORA
