...
<head>
  ...
  <meta content='Es un equipo que ayuda a mantener un cuerpo sano, al esculpir los músculos de manera estética.' />
  ...
  <meta name="twitter:description" content="Es un equipo que ayuda a mantener un cuerpo sano, al esculpir los músculos de manera estética.">
  ...
  <meta name="description" content="Es un equipo que ayuda a mantener un cuerpo sano, al esculpir los músculos de manera estética.">
...
<body>
  ...
  <div class="fb-customerchat" attribution=setup_tool page_id="1439383766342268" logged_in_greeting="¡Hola! ¿Tienes alguna duda sobre nuestros equipos? Contáctanos" logged_out_greeting="¡Hola! ¿Tienes alguna duda sobre nuestros equipos? Contáctanos">
  </div>
    ...
    <div id="wrapper">
            ...
            <div class="row">
              <div class="col-md-6 col-12 father-div">
                <div class="son-div">
                  ...
                  <h2 id="LIPO1060-title" class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7">Sistema <strong>Electromagnético</strong> de <strong>Alta Intensidad</strong></h2>
      ...
      <div id="introduccion" class="container mt-3 section">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h4 class="text-center color-sub-lipo1060 mb-2 fadeInDown animation-delay-5">Es un equipo que ayuda a mantener un cuerpo sano, al esculpir los músculos de manera estética.</h4>
            <h4 class="text-center color-sub-lipo1060 mb-2 fadeInDown animation-delay-5">Sus dos piezas de mano realizan un tratamiento efectivo de abdomen, hombro, muslos, glúteo y más.</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-8 father-div">
              <div class="son-div">
                <h3 class="color-dark mb-2 fadeInDown animation-delay-5">¿Por qué <strong class="color-primary-coresculpt">CoreSculpt</strong>?</h3>
                <h6 class="color-dark">1. Refuerzo Muscular</h6>
                <p class="color-dark">El campo electromagnético es efectivo para la prevención de hernia de disco, corrección de postura, alivia el dolor de espalda y más.</p>
                <h6 class="color-dark">2. Alivio del Dolor</h6>
                <p class="color-dark">Energía Electromagnética con 3 tesla de alta intensidad contraen y relajan los músculos de manera repetitiva. <br>Contrae: fibras intrafusales, fibras sensoriales y fibras extrafusales.</p>
                <h6 class="color-dark">3. Efecto de Ejercicio Máximo Efectivo</h6>
                <p class="color-dark">Energía electromagnética de alta intensidad contrae y relaja los músculos mínimo 20,000 a un máximo de 36,000 veces en una sesión de 30 minutos. Esta simulación del músculo tiene el mismo efecto que hacer sentadillas o abdominales.</p>
              </div>
          ...
          <div class="row">
            <div id="aplicaciones" class="col-md-6">
              <div id="aplica-facial-info">
                <h3 class="text-center color-primary-coresculpt text-light mb-2 fadeInDown animation-delay-5">APLICACIÓN CORPORAL</h3>
            ...
            <div id="aplicacion-facial" class="col-md-6">
              <figure>
                <img src="assets/img/products/coresculpt/aplicacion-corporal-coresculpt.png" alt="Resultados de la aplicación corporal de CoreSculpt" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
      ...
      <section id="funcionamiento-coresculpt" class="section ms-hero-img-room color-white intro-hero-full">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center text-white text-light mb-2 fadeInDown animation-delay-5">Los pacientes sienten sólo <strong class="color-secondary-coresculpt">Profundas contracciones Musculares</strong> como al hacer el ejercicio más intenso!</h3>
              <p class="text-center text-white destacado">El Campo Magnético de pulso sólido es instantáneamente transmitido hacia un conducto que es fácilmente transmitido por un campo magnético así como al cuerpo humano, resultando en corrientes inducidas. Estas inducidas biocorrientes afectan cada tejido del cuerpo humano con mecanismos electrofisiológicos y estos efectos electrofisiológicos aparecen en los nervios sensoriales, vasos sanguíneos, tejido óseo, etc.</p>
              <p class="text-center text-white destacado">El campo magnético además de ser inofensivo, también trabaja de manera profunda activando células, nervios y tejido muscular, creando resultados extraordinarios.</p>
            </div>
          </div>
          <div class="row mt-3">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p class="color-text-lipo1060">La potente circulación del agua calma el calor de la bobina para tener un tratamiento satisfactorio sin tiempo de inactividad.<br>No hay ningún peligro de fuga de aceite y agua.</p>
      ...
      <section id="" class="section bg-coresculpt-one">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center color-white mb-4">La pieza de mano genera pulsaciones Electromagnéticas. <br>El paciente sólo se recuesta en una cama durante 30 minutos por área a tratar. <br>Sólo son 4 sesiones por 2 semanas.</h3>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="destacado">Con <strong>CoreSculpt</strong> obtendrás los mejores resultados en Modelado Corporal, al esculpir eficazmente áreas como abdomen, hombro, muslos, glúteo y más.</p>
            </div>
          </div>
          <!--.row-->
          <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/coresculpt/Core_PacienteD_1.jpg" data-lightbox="gallery" data-title="atamiento en glúteos con CoreSculpt">
                              <img src="assets/img/casos-clinicos/coresculpt/Core_PacienteD_1-thumb.jpg" alt="Tratamiento en glúteos con CoreSculpt" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/coresculpt/Core_PacienteE_3.jpg" data-lightbox="gallery" data-title="Tratamiento en glúteos con CoreSculpt">
                              <img src="assets/img/casos-clinicos/coresculpt/Core_PacienteE_3-thumb.jpg" alt="Tratamiento en glúteos con CoreSculpt" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/coresculpt/Core_PacienteD_2.jpg" data-lightbox="gallery" data-title="atamiento en glúteos con CoreSculpt">
                              <img src="assets/img/casos-clinicos/coresculpt/Core_PacienteD_2-thumb.jpg" alt="Tratamiento en glúteos con CoreSculpt" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/coresculpt/Core_PacienteE_4.jpg" data-lightbox="gallery" data-title="Tratamiento en glúteos con CoreSculpt">
                              <img src="assets/img/casos-clinicos/coresculpt/Core_PacienteE_4-thumb.jpg" alt="Tratamiento en glúteos con CoreSculpt" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/coresculpt/Core_PacienteF_2.jpg" data-lightbox="gallery" data-title="Tratamiento en Glúteos con CoreSculpt">
                              <img src="assets/img/casos-clinicos/coresculpt/Core_PacienteF_2-thumb.jpg" alt="Tratamiento en Glúteos con CoreSculpt" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-6 mt-6">
              ...
              <form method="post" action="contact_eqpmnt.php" class="container-fluid contactEqpmnt">
                <div class="row" style="display: none;">
                  <input type="text" name="contactDpmnt" id="contactDpmnt" value="Ventas Equipos">
                  <input type="text" name="contactSubject" id="contactSubject" value="Interés en <?php echo $equipo; ?>">
                  <input type="text" name="localUrl" id="localUrl" value="<?php echo strtolower(str_replace(' ', '-', $equipo)); ?>.php">
                </div>
                <div class="row">
                  <div class="col-sm-12">
