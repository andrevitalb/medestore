...
<html lang="es">
  <head>
    ...
    <!-- METAS FACEBOOK -->
        ...
        <meta content='https://www.medestore.mx/assets/img/facebook-thumbnails/clearlight-facebook.png' property='og:image'/>
        <meta content='Solución probada para todas las aplicaciones de eliminación de vello' property='og:description'/>
        ...
        <meta name="twitter:description" content="Solución probada para todas las aplicaciones de eliminación de vello.">
        <meta name="twitter:image" content="https://www.medestore.mx/assets/img/facebook-thumbnails/clearlight-facebook.png">
    <title>MedeStore | Clearlight</title>
    <meta name="description" content="El mejor equipo con tecnología láser Diodo 808nm para la eliminación de cualquier tipo de vello.">
...
<div class="fb-customerchat"
  ...
  logged_out_greeting="¡Hola! ¿Tienes alguna duda sobre nuestros equipos? Contáctanos">
    ...
    <div class="ms-site-container">
      ...
      <div id="wrapper">
          <div id="home-stage" class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full clearlight-bg section">
                          ...
                          <div class="col-md-6 father-div">
                              ...
                              <span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
                                  <figure class="logo-product">
                                    <img src="assets/img/products/clearlight/logo-clearlight.png" alt="Logotipo de Clearlight" class="img-fluid">
                                  </figure>
                              </span>
                              <h2 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7">Más de lo que esperabas en depilación efectiva</h2>
                              <h1 class="animated fadeInUp animation-delay-12 color-white">Depilación láser
                          ...
                          <div class="col-md-6">
                            <div class="center-block mt-2 animated zoomInDown animation-delay-8">
                                <figure class="stage-product">
                                    <img src="assets/img/products/clearlight/stage-clearlight.png" alt="Equipo Clearlight" class="img-fluid">
                                </figure>
                            </div>
                        </div>
                      </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4 class="text-center color-secondary-clearlight mb-2 fadeInDown animation-delay-5">Solución probada para todas las aplicaciones de eliminación de vello</h4>
        
                        <p class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4"><strong>Clearlight</strong> facilita la depilación profesional y la hace más eficiente.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 text-center">
                        <figure>
                            <img src="assets/img/products/clearlight/hand-clearlight.png" alt="Pieza de mano de Clearlight" class="img-fluid">
                        </figure>
                    </div>
                </div>
        ...
        <section id="funcionamiento-clearlight" class="section ms-hero-img-room color-white intro-hero-full">
            <div class="container">
                <div class="row">
                    <div id="full-clearlight" class="col-md-3 text-center">
                        <figure>
                            <img src="assets/img/products/clearlight/clearlight-full.png" alt="Equipo Clearlight" class="img-fluid">
                        </figure>
                    </div>
                    <div class="col-md-9 father-div">
                        <div class="son-div">
                            <h3 class="text-white mb-2 fadeInDown animation-delay-5">¿Por qué <strong class="color-white">Clearlight</strong>?</h3>
                            <h6 class="color-white">1. Ventajas para el usuario</h6>
                                  ...
                                  <ul class="list-mobile text-white">
                                    ...
                                    <li>Ahorro de tiempo gracias al pulso de alta potencia y al área de disparo más grande.</li>
              ...
              <div class="row">
                  <div id="aplicaciones" class="col-md-6">
                      <div id="aplica-facial-info">
                          <h3 class="text-center color-primary-clearlight text-light mb-2 fadeInDown animation-delay-5">TRATAMIENTO DE DEPILACIÓN</h3>
                          <ul class="facial-list">
                              <li>Elimina cualquier tipo de vello.</li>
                              <li>Seguro y con menos sesiones que otros tratamientos.</li>
                              <li>Cualquier persona es candidata para este procedimiento, tomando en cuenta su historial clínico y el tipo de piel que posee.</li>
                  ...
                  <div id="aplicacion-facial" class="col-md-6">
                      <figure>
                          <img src="assets/img/products/clearlight/aplicacion-clearlight.png" alt="Resultados de depilación con Clearlight" class="img-fluid">
                      </figure>
                  </div>
              </div>
            </div>
        ...
        <section id="gfr-ultracel"  class="section bg-blue-clearlight">
            <div class="container">
              ...
              <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-center color-white text-light mb-2 fadeInDown animation-delay-5">Sistema Láser Diodo de alta potencia</h4>
        
                        <p class="lead text-center aco color-white fadeInDown animation-delay-6 center-block mb-4">El <strong>Clearlight</strong> está especialmente diseñado para la eliminación de vello. La tecnología de pulso de alta potencia realiza un rápido y efectivo tratamiento; además las ondas continuas y el sistema de enfriamiento por chiller lo hacen el más seguro.</p>
                    </div>
                </div>
                
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-center color-white text-light mb-2 fadeInDown animation-delay-5">Tecnología de pulso avanzada</h4>
        
                        <p class="lead text-center aco color-white fadeInDown animation-delay-6 mw-800 center-block mb-4">El modo <strong>HRS</strong> incluye funciones especializadas de 4 pulsos, ayuda a reducir el dolor y mejora el efecto del tratamiento.</p>
                    </div>
                </div>
                <div class="row">
                  <div class="col-md-12 text-center">
                    <figure>
                      <img src="assets/img/products/clearlight/pulsos-clearlight.png" alt="Tecnología avanzada de pulsos de Clearlight" class="img-fluid">
                    </figure>
                  </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4 class="text-center color-primary-clearlight text-light mb-2 fadeInDown animation-delay-5">Tratamiento de alta velocidad</h4>
        
                        <p class="lead text-center aco color-dark fadeInDown animation-delay-6 mw-900 center-block mb-4">Alta frecuencia de repeticiones que facilita al usuario el manejo.<br><strong>Modo HRS:</strong> hasta 3 Hz <br><strong>Modo HRM:</strong> hasta 15 Hz <br><strong>Modo STM:</strong> hasta 10 Hz</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center">
                        ...
                        <h4 class="text-center color-primary-clearlight text-light mb-2 fadeInDown animation-delay-5">Profundidad de penetración</h4>
                        <figure class="movil-image">
                            <img src="assets/img/products/clearlight/penetracion-clearlight.png" alt="Profundidad de penetración de Clearlight" class="img-fluid">
                        </figure>
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <h4 class="text-center color-primary-clearlight text-light mb-2 fadeInDown animation-delay-5">Tamaño grande de disparo</h4>
                        <p class="color-dark">Tamaño del punto mejorado a 14mm x 14mm</p>
                        <figure class="movil-image">
                            <img src="assets/img/products/clearlight/spot-size.png" alt="Tamaño de disparo de Clearlight" class="img-fluid">
                        </figure>
                    </div>
                </div>
            </div>  
              ...
              <div class="row">
                  <div class="col-md-7 col-12">
                      <div class="title-data-sheet">
                        <figure class="logo-product">
                            <img src="assets/img/products/clearlight/logo-ClearLight-full.png" alt="Logotipo de Clearlight" class="img-fluid">
                        </figure>
                      </div>
                    ...
                    <div class="download-brochure">
                      <a href="assets/brochures/brochure-Clearlight.pdf" class="btn btn-raised btn-primary btn-brochure" target="_blank">DESCARGAR FOLLETO</a>
                    </div>
                </div>
            </div>
        </div>
