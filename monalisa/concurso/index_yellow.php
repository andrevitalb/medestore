<?php session_start();
    ...
    if(!isset($_SESSION['usr']) || $_SESSION['usr'] != 1003) {
                ...
                <div class="col-lg-12">
                    ...
                    <div class="content-box big-box">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2>Agregar stock:</h2>
                                <h5> *Agregar códigos separados por saltos de línea (Enter).</h5>
                            </div>
                        </div>
                        ...
                        <form action="" method = "post">
                            <div class="row">
                                <div class="col-lg-12">
                                    <textarea name="stockQuery" id="stockQuery"></textarea>
                                </div>

                                <div class="caption text-center">
                                    <button class="btn btn-primary" type = "submit" name = "add_stock">Agregar stock</button> 
                                </div>
                            </div>
                        </form>

                        <div class="col-lg-3"></div>
                        <div class="col-lg-6 notifStock">
                            <?php 
                                if(isset($_POST["add_stock"])){
                                    addStock();
                                    $stock = stockCorrect();
                                    if($stock != 1) stockIncorrect();
                                    get_Stock();
                                }
                            ?>
                        </div>
