...
<html lang="es">
	<head>
		...
		<meta
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/ultracel-facebook.png"
			property="og:image"
		/>
		<meta
			content="El primer y único sistema que integra las tres mejores tecnologías para el tratamiento de la piel. HIFU, Radiofrecuencia y Radiofrecuencia fraccionada. Terapia integral para la piel."
		/>
	...
	<body>
		...
		<div class="ms-site-container">
			...
			<div id="wrapper">
				<div
					id="home-stage"
					class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full ultracel-bg section"
				>
									...
									<div class="son-div">
										<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
											<figure class="logo-product">
												<img
													src="assets/img/products/ultracel/logo-ulracel.png"
													alt="Logotipo ULTRAcel"
													class="img-fluid"
												/>
											</figure>
										</span>
										<h2
											class="no-m ms-site-title color-primary-ultracel center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7"
										>
											Tres en uno. <br /><strong>¡Terapia que penetra en todas las capas!</strong>
										</h2>
										<h1 class="animated fadeInUp animation-delay-12 color-primary-ultracel">
											Tecnología
								...
								<div class="col-md-6">
									<div class="center-block mt-2 animated zoomInDown animation-delay-8">
										<figure class="stage-product">
											<img
												src="assets/img/products/ultracel/ultracel-stage.png"
												alt="Equipo ULTRAcel"
												class="img-fluid"
											/>
										</figure>
				...
				<section class="section">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								>
									Terapia integral para la piel
								</h4>

								<p
									class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4"
								>
									<strong>ULTRAcel</strong> es el primer y único sistema que integra las tres
									mejores tecnologías para el tratamiento de la piel.
								</p>
							</div>
						</div>
					</div>
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-4">
								<figure>
									<img
										src="assets/img/products/ultracel/disparador-ultracel03.png"
										alt="Pieza de mano HIFU de ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
							<div class="col-md-4">
								<figure>
									<img
										src="assets/img/products/ultracel/disparador-ultracel01.png"
										alt="Pieza de mano de Radiofrecuencia Fraccionada con Micro-agujas de ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
							<div class="col-md-4">
								<figure>
									<img
										src="assets/img/products/ultracel/disparador-ultracel02.png"
										alt="Pieza de mano de Radiofrecuencia Fraccionada Superficial de ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row mtop30 mt-4">
							<div class="col-md-12">
								<p
									class="lead text-center aco fadeInDown animation-delay-6 mw-800 center-block mb-4 color-primary-ultracel"
								>
									Esta combinación de tecnologías permite gran variedad de tratamientos de forma
									rápida y efectiva con resultados inigualables.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							<div id="" class="col-md-3 text-center">
								<figure>
									<img
										src="assets/img/products/ultracel/completo-ultracel.png"
										alt="Equipo ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							...
							<div class="col-md-9 father-div">
								<div class="son-div">
									<h3 class="text-dark mb-2 fadeInDown animation-delay-5">
										¿Por qué <span class="color-primary-ultracel_q">ULTRAcel™ HIFU</span>?
									</h3>
									<h6 class="color-primary-ultracel">1. Transductores con potencia elevada</h6>
									<ul class="list-mobile text-dark">
										<li>
											Crea una zona de coagulación de tamaño adecuado a la profundidad deseada.
										</li>
										<li>
											Crea una zona de coagulación de más de 60 ºC en la piel mediante potencia
											elevada.
										</li>
										<li>Aplicación de hasta 3.0J de energía.</li>
									</ul>
									<h6 class="color-primary-ultracel">
										2. Permite el uso de cartuchos con calidad confiable
									</h6>
									<ul class="list-mobile text-dark">
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div id="aplicacion-facial" class="col-md-6">
								<figure>
									<img
										src="assets/img/products/ultracel/aplicacion-facial-ultracel.png"
										alt="Aplicación facial con ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								>
									La tecnología FUS (HIFU) de ULTRAcel emite ultrasonido de alta intensidad en las
									capas de grasa y SMAS, por medio de dos tipos de puntas: 3.0mm y 4.5mm, ambas a
									7MHz.
								</p>
							</div>
						</div>
						<div class="big-image row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/ultracel/fus-techno-hand.png"
										alt="Pieza de mano FUS / HIFU de ULTRAcel "
										class="img-fluid"
									/>
								</figure>
							</div>
						...
						<div class="row fus-steps mt-2">
							<div class="xs-image col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/ultracel/fus-irradiacion.png"
										alt="Irradiación de energía con ULTRAcel"
										class="img-fluid"
									/>
								</figure>
								...
								<p class="text-center color-white text-mobile">
									La energía FUS es irradiada en varios pasos a profundidades de 3.0 o 4.5mm.
								</p>
							</div>
							<div class="xs-image col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/ultracel/fus-coagulacion.png"
										alt="Coagulación con ULTRAcel"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-white">
									<span class="no-mobile">02 |</span> Coagulación
								</h6>
								<p class="text-center color-white text-mobile">
									El SMAS a una profundidad de 4.5mm es coagulado por las emisiones de ultrasonido
							...
							<div class="xs-image col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/ultracel/fus-regeneracion.png"
										alt="Efecto lifting con ULTRAcel"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-white">
									<span class="no-mobile">03 |</span> Regeneración
								</h6>
								<p class="text-center color-white text-mobile">
									La piel se regenera y se logra un efecto lifting gracias a la generación de nuevo
									colágeno y elastina.
								</p>
							</div>
						</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<h4
									class="text-center color-primary-ultracel text-light mb-2 fadeInDown animation-delay-5"
								>
									Radiofrecuencia Fraccionada con Micro-agujas
								</h4>

								<p
									class="lead text-center aco color-primary-ultracel fadeInDown animation-delay-6 mw-800 center-block mb-4"
								>
						...
						<div class="big-image row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/ultracel/frm-techno-hand.png"
										alt="Pieza de mano FRM de ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
						...
						<div class="row">
							<div class="col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/ultracel/ssr-superficial.png"
										alt="Rejuvenecimiento y regeneración de la epidermis con ULTRAcel"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-ultracel">01 | SRR Superficial</h6>
								<p class="text-center color-primary-ultracel no-mobile">
									Modalidad para rejuvenecimiento y regeneración de la epidermis.
								</p>
							</div>
							<div class="col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/ultracel/frm-monopolar.png"
										alt="Modo Monopolar de UlTRAcel"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-ultracel">02 | FRM Monopolar</h6>
								<p class="text-center color-primary-ultracel no-mobile">
									Modalidad con sistema ERS (Energy Reward System) por medición de impedancia,
									provee un área de acción mayor que el modo Bipolar.
								</p>
							</div>
							<div class="col-md-4">
								<figure class="text-center">
									<img
										src="assets/img/products/ultracel/frm-bipolar.png"
										alt="FRM Bipolar de ULTRAcel"
										class="img-fluid"
									/>
								</figure>
								<h6 class="text-center color-primary-ultracel">03 | FRM Bipolar</h6>
								<p class="text-center color-primary-ultracel no-mobile">
									Modalidad que concentra la energía de radiofrecuencia en el área objetivo.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								>
									La modalidad GFR crea una cuadrícula térmica en la epidermis y una zona de calor
									uniforme en la dermis superficial durante la emisión de Radiofrecuencia.
								</p>
							</div>
						</div>
						<div class="big-image row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/ultracel/gfr-techno-hand.png"
										alt="Pieza de mano GFR de ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<p
									class="lead text-center aco color-white fadeInDown animation-delay-6 center-block mt-2 mb-4"
								>
									El sistema GFR incluye un generador de 6MHz que conduce radiofrecuencia a través
									de puntas sofisticadas. La punta GFR enfoca su energía solo en el área que cubre.
									El calentamiento por medio de GFR crea una cuadrícula térmica en la epidermis y
									una zona de calor uniforme en la dermis superficial.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<figure>
									<img
										src="assets/img/products/ultracel/gfr-piel.png"
										alt="Efecto de calor em ña epidermis con ULTRAcel"
										class="img-fluid"
									/>
								</figure>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<p class="destacado">
									Con <strong>ULTRAcel</strong> obtendrás los mejores resultados en un menor tiempo
									en aplicación facial o corporal.
								</p>
							</div>
						</div>
						<!--.row-->
												...
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/ultracel/caso01_ultracel.png"
																data-lightbox="gallery"
																data-title="Tratamiento en mejillas"
															>
																<img
																	src="assets/img/casos-clinicos/ultracel/caso01_ultracel-thumb.png"
																	alt="Tratamiento en mejillas con ULTRAcel"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/ultracel/caso02_ultracel.png"
																data-lightbox="gallery"
																data-title="Tratamiento en cuello"
															>
																<img
																	src="assets/img/casos-clinicos/ultracel/caso02_ultracel-thumb.png"
																	alt="Tratamiento en cuello con ULTRAcel"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/ultracel/caso03_ultracel.png"
																data-lightbox="gallery"
																data-title="Tratamiento en cuello"
															>
																<img
																	src="assets/img/casos-clinicos/ultracel/caso03_ultracel-thumb.png"
																	alt="Tratamiento en cuello con ultracel"
																	class="img-fluid"
																/>
															</a>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/ultracel/caso04_ultracel.png"
																data-lightbox="gallery"
																data-title="Tratamiento en pliegue nasolabial"
															>
																<img
																	src="assets/img/casos-clinicos/ultracel/caso04_ultracel-thumb.png"
																	alt="Tratamiento en pliegue nasolabial con ULTRAcel"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/ultracel/caso05_ultracel.png"
																data-lightbox="gallery"
																data-title="Tratamiento en marcas de acné"
															>
																<img
																	src="assets/img/casos-clinicos/ultracel/caso05_ultracel-thumb.png"
																	alt="Tratamiento en marcas de acné con ULTRAcel"
																	class="img-fluid"
																/>
															</a>
														</div>
											...
											<div class="col-md-4 col-12">
												<div class="card">
													<div class="card-block p-05">
														<div class="withripple">
															<a
																href="assets/img/casos-clinicos/ultracel/caso06_ultracel.png"
																data-lightbox="gallery"
																data-title="Tratamiento en papada"
															>
																<img
																	src="assets/img/casos-clinicos/ultracel/caso06_ultracel-thumb.png"
																	alt="Tratamiento en papada con ULTRAcel"
																	class="img-fluid"
																/>
															</a>
														</div>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="card">
									<div
										...
										data-plyr-embed-id="34drHeV7eFw"
										class="js-player"
									></div>
								</div>
							</div>
							<div class="col-md-4">
								...
								<div class="card">
									<div
										data-plyr-provider="youtube"
										data-plyr-embed-id="3830HAcDim8"
										class="js-player"
									></div>
								</div>
							</div>
							<div class="col-md-4">
								...
								<div class="card">
									<div
										data-plyr-provider="youtube"
										data-plyr-embed-id="rLvsHfA2gkw"
										class="js-player"
									></div>
								</div>
							</div>
							...
							<div class="col-md-7 col-12">
								...
								<div class="data-sheet-contain">
									...
									<table class="table table-responsive">
										...
										<tbody>
											<tr>
												<td rowspan="6" valign="middle" class="row-span border-end">
													<strong>HIFU</strong>
												</td>
								...
								<div class="download-brochure">
									<a
										href="assets/brochures/brochure-ULTRAcel.pdf"
