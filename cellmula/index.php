...
<html lang="es">
	<head>
		...
		<meta
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/cellmula-facebook-generic.png"
			property="og:image"
		/>
		<meta
	...
	<body>
		...
		<div class="ms-site-container">
			...
			<div id="wrapper">
				<div class="ms-hero-page ms-hero-video ms-hero-img-room color-white cellmula-bg section">
						...
						<div class="container text-center">
							<div class="row">
								<div class="col-md-12">
									...
									>
										Factores de <strong>crecimiento</strong> + <strong>Péptidos</strong>
									</h2>
							...
							<div class="row">
								<div class="col-md-6">
									...
									>
										<a href="cellmula-hd.php" class="color-white link-stage"
											>Regeneración capilar <i class="fa fa-angle-right"></i
										></a>
									</h4>
									<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
										<figure class="logo-product">
											<a href="cellmula-hd.php"
												><img
													src="../assets/img/products/cellmula/HD-solution-stage.png"
													alt="CELLMULA HD Solution "
													class="img-fluid"
											/></a>
										</figure>
									</span>
								...
								<div class="col-md-6">
									<h4
										class="no-m ms-site-title color-white center-block mt-2 animated zoomInDown animation-delay-7 sub2"
									>
										<a href="cellmula-hsr.php" class="color-white link-stage"
											>Rejuvenecimiento facial <i class="fa fa-angle-right"></i
										></a>
									</h4>
									<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
										<figure class="logo-product">
											<a href="cellmula-hsr.php"
												><img
													src="../assets/img/products/cellmula/HSR-solution-MS.png"
													alt="CELLMULA HSR Solution "
													class="img-fluid"
											/></a>
										</figure>
									</span>
