...
<html lang="es">
	<head>
		...
		<meta
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/CELLMULA_HSR-FB.png"
			property="og:image"
		/>
		<meta
			content="Nueva línea cosmética dermatológica especializada en el rejuvenecimiento facial."
			property="og:description"
		/>
		<meta property="og:type" content="website" />
		<meta property="og:url" content="https://www.medestore.mx/cellmula/cellmula-hsr.php" />
		...
		<meta
			...
			content="https://www.medestore.mx/assets/img/facebook-thumbnails/CELLMULA_HSR-FB.png"
		/>
		<title>Medestore | CELLMULA HSR</title>
		<meta
			name="description"
			content="Nueva línea cosmética dermatológica especializada en el rejuvenecimiento facial."
		/>
	...
	<body>
		...
		<div class="ms-site-container">
			...
			<div id="wrapper">
				<div
					class="ms-hero-page ms-hero-video ms-hero-img-room color-white intro-hero-full cellmula-hsr-bg section"
				>
								...
								<div class="col-md-6">
									<span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
										<figure class="logo-product">
											<img
												src="../assets/img/products/cellmula/logo-white-cellmula-hsr.png"
												alt="Logotipo de CELLMULA HSR"
												class="img-fluid"
											/>
										</figure>
									</span>
									...
									>
										<strong>Nuevo paradigma</strong> de <strong>rejuvenecimiento facial</strong>
									</h2>
								...
								<div class="col-md-6">
									<div class="center-block mt-2 animated zoomInDown animation-delay-8">
										<figure class="stage-product">
											<img
												src="../assets/img/products/cellmula/HSR-solution-MS.png"
				...
				<section class="section">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="text-center color-primary-cellmula mb-2">CELLMULA HSR Solución</h2>
								<h4
									class="text-center color-secondary-cellmula text-light mb-2 fadeInDown animation-delay-5"
								>
									¡Es tiempo de reiniciar el reloj biológico!
								</h4>

								<p
									class="lead text-center aco fadeInDown animation-delay-6 mw-800 color-text-cellmula center-block mb-4"
								>
									<strong>Eunsung,</strong> líder global en innovación en el campo de medicina
									estética, presenta su nueva línea dermatológica especializada, CELLMULA HD.
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 offset-md-3 text-center">
								<figure>
									<img
										src="../assets/img/products/cellmula/productos-hsr.png"
										alt="Productos CELLMULA HSR para cuidado de la piel"
										class="img-fluid"
									/>
								</figure>
							</div>
							...
							<div id="aplicaciones2" class="col-md-6">
								<div id="aplica-corporal-info">
									...
									<ul class="facial-list">
										...
										<li>Reduce el poro agrandado.</li>
									</ul>
									<p class="text-center">
										Mayor efectividad al aplicar la solución con <strong>EPNeedle</strong> u otro
										dispositivo MTS.
									</p>
								</div>
							</div>
				...
				<section id="factores-hsr" class="section">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="text-center color-primary-cellmula mb-2">Factores de crecimiento</h2>
								<h4
									class="text-center color-secondary-cellmula text-light mb-2 fadeInDown animation-delay-5"
								>
									CELLMULA HSR
								...
								>
									¿Cómo ayudan los factores de crecimiento de <strong>CELLMULA HSR</strong> al
									rejuvenecimiento facial?
								</p>
							</div>
						</div>
						...
						<div class="row detalles-big02">
							<div class="col-md-3 text-center">
								<h4 class="color-dark sub2">sh-Polipéptido-1 <br class="no-mobile" />(bFGF)</h4>
								<p class="color-dark">
									Incrementa la síntesis de colágeno, elastina y la microcirculación sanguínea,
									promueve el rejuvenecimiento cutáneo y la curación de heridas.
								</p>
							</div>
							<div class="col-md-3 text-center">
								<h4 class="color-dark sub2">sh-Oligopéptido-2 <br class="no-mobile" />(IGF1)</h4>
								<p class="color-dark">
									Mejora la elasticidad en la piel, reduce arrugas finas e incrementa los niveles de
									colágeno y elastina.
								</p>
							</div>
							<div class="col-md-3 text-center">
								<h4 class="color-dark sub2">sh-Oligopéptido-1 <br class="no-mobile" />(EGF)</h4>
								<p class="color-dark">
									Estimula la proliferación de células epidérmicas, ayuda a la reparación de tejidos
									y curación de heridas.
								</p>
							</div>
							<!-- <div class="col-md-3 text-center">
                    <h4 class="color-dark sub2">sh-Polipéptido-2 <br class="no-mobile">(TRX)</h4>
                    <p class="color-dark">Antioxidante que neutraliza los radicales libres y protege la piel.</p>
                  </div> -->
							<div class="col-md-3 text-center">
								<h4 class="color-dark sub2">Tripéptido de cobre-1 <br class="no-mobile" /></h4>
								<p class="color-dark">
									Acelera la curación de heridas, aumenta la producción de ácido hialurónico,
									colágeno y elastina.
								</p>
							</div>
						</div>
					...
					<div class="container-fluid">
						...
						<div class="row text-center">
							<div class="col-md-4 monalisa-soft">
								...
								<h4 class="color-primary-cellmula sub2">True Repair Cream</h4>
								<h6 class="sub">Crema Reparadora</h6>
							</div>
							<div class="col-md-4 monalisa-mild">
								...
								<h4 class="color-primary-cellmula sub2">Wrinklear EGF Ampoule</h4>
								<h6 class="sub">Ampolleta con FCE para arrugas</h6>
							</div>
							<div class="col-md-4 monalisa-hard">
								...
								<h4 class="color-primary-cellmula sub2">UV Shield Sun</h4>
								<h6 class="sub">Bloqueador UV</h6>
							</div>
						</div>
					</div>
				</section>
