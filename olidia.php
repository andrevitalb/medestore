...
<head>
  ...
  <meta content='https://www.medestore.mx/assets/img/facebook-thumbnails/olidia-facebook.png' property='og:image' />
  <meta content='El confiable y efectivo estimulador de colágeno Olidia, es un tratamiento estético inyectable y biocompatible que ayuda a restaurar el volumen natural de la piel envejecida que ha perdido colágeno.' />
  ...
  <meta name="twitter:description" content="El confiable y efectivo estimulador de colágeno Olidia, es un tratamiento estético inyectable y biocompatible que ayuda a restaurar el volumen natural de la piel envejecida que ha perdido colágeno.">
  <meta name="twitter:image" content="https://www.medestore.mx/assets/img/facebook-thumbnails/olidia-facebook.png">
  <title>MedeStore | Olidia</title>
  <meta name="description" content="El confiable y efectivo estimulador de colágeno Olidia, es un tratamiento estético inyectable y biocompatible que ayuda a restaurar el volumen natural de la piel envejecida que ha perdido colágeno.">
    ...
    <div id="wrapper">
                ...
                <div class="son-div">
                  <span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
                    <figure class="logo-product">
                      <img src="assets/img/products/olidia/logo-olidia-white.png" alt="Logotipo de Olidia" class="img-fluid">
                    </figure>
                  </span>
                  <h2 id="LIPO1060-title" class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7"><strong class="">Diamond</strong><br><strong class="">Collagen</strong></h2>
              ...
              <div class="col-md-6">
                <div class="center-block mt-2 animated zoomInDown animation-delay-8">
                  <figure class="stage-product">
                    <img src="assets/img/products/olidia/olidia-ampolleta-01.png" alt="Ampolleta Olidia" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
      ...
      <div id="introduccion" class="container mt-3 section">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h4 class="text-center color-sub-lipo1060 mb-2 fadeInDown animation-delay-5">Polvo de Ácido POLI-L-LÁCTICO INYECTABLE</h4>
            <p class="text-center color-text-lipo1060 destacado">El confiable y efectivo estimulador de colágeno <strong class="color-primary-olidia">Olidia</strong>, es un tratamiento estético inyectable y biocompatible que ayuda a restaurar el volumen natural de la piel envejecida que ha perdido colágeno.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="center-block mt-2 animated zoomInDown text-center animation-delay-9">
              <figure>
                <img src="assets/img/products/olidia/olidia-ampolleta-caja.png" alt="Producto Olidia" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
      ...
      <section id="" class="section ms-hero-img-room color-white intro-hero-full bg-olidia-two">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-center color-sub-lipo1060 text-light mb-2 fadeInDown animation-delay-5">Collagen is the key factor</h2>
              <p class="text-center color-text-lipo1060 destacado">El colágeno es el ingrediente principal para una piel sana y joven. A medida que las personas envejecen, el colágeno se pierde gradualmente desde los 20 años y su tasa de reducción es de 1% anual. La piel adulta disminuye la capacidad de producción de colágeno, para los 50 años la piel habrá perdido el 30% de este. La principal razón de las arrugas y plieges es la pérdida de colágeno, causando que la piel fina se haga flácida y se vea envejecida.</p>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-4 col-12">
              <figure class="text-center tecno-vacuum">
                <img src="assets/img/products/olidia/olidia-keyfactor01.png" alt="Olidia Key factor" class="img-fluid">
              </figure>
              <p class="text-center color-text-lipo1060 mt-2">Alta densidad de colágeno y elastina.</p>
            </div>
            <div class="col-md-4 col-12">
              <figure class="text-center tecno-vacuum">
                <img src="assets/img/products/olidia/olidia-keyfactor02.png" alt="Olidia Key factor" class="img-fluid">
              </figure>
              <p class="text-center color-text-lipo1060 mt-2">Degradación del colágeno y la elastina.</p>
            </div>
            <div class="col-md-4  col-12">
              <figure class="text-center tecno-vacuum">
                <img src="assets/img/products/olidia/olidia-keyfactor03.png" alt="Olidia Key factor" class="img-fluid">
              </figure>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-8 father-div">
              <div class="son-div">
                <h3 class="text-dark mb-2 fadeInDown animation-delay-5">¿Por qué <span class="color-primary-olidia">Olidia?</h3>
                ...
                <p class="text-dark">El volumen generado con el propio colágeno dura más de 2 años.</p>
                <h6 class="color-primary-olidia">3. Tiempo de recuperación rápido</h6>
                <p class="text-dark">Con menos tiempo de inactividad, fácil de regresar a su rutina.</p>
                ...
                <p class="text-dark">Mejora de las arrugas mediante la renaturalización del colágeno perdido.</p>
                <h6 class="color-primary-olidia">6. Seguro</h6>
                <p class="text-dark">Aprobado por el MDFS de Corea y con la marca CE.3). El principal ingrediente Ácido Poliláctico es biodegradable.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="aplicacion-facial-info" class="section">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-center color-dark mb-2 ">Otros vs <span class="color-primary-olidia">Olidia</span></h2>
          ...
          <div class="row">
            <div id="aplicaciones" class="col-md-12 col-12">
              ...
              <table class="table table-responsive table-bordered text-center no-mobile">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Tanto para zonas estrechas como para zonas anchas.<br> *Zona estrecha (pliegues nasolabiales, nariz, barbilla, frente, ceño, lagrimal, pómulo).<br>*Zona ancha (mejilla, sien, etc.).</td>
                          <td>Principalmente para zonas estrechas (pliegues nasolabiales, nariz, barbilla, frente, entrecejo, lagrimal, malar).</td>
                          <td>Principalmente para zonas amplias (mejilla, toda la cara incluyendo la sien).</td>
                        </tr>
                        <tr>
                          <td><strong>Duración del efecto</strong></td>
                          <td>Más del 80% se mantiene durante 25 meses. Después de 3-4 inyecciones iniciales, no hay necesidad de inyecciones adicionales durante 2-3 años.</td>
              ...
              <div class="bs-example">
                    <table class="table table-responsive table-bordered text-center no-desktop" style="vertical-align: middle;">
                      <tbody>
                        <tr>
                          <th>Olidia</th>
                          <th>Relleno AH</th>
                        ...
                        <tr>
                          <td style="vertical-align: middle;" class="info-coolite">Ácido Poli-L-Láctico (biodegradable)</td>
                        ...
                        <tr>
                          <td style="vertical-align: middle;" class="info-coolite">Tanto para zonas estrechas como para zonas anchas.<br> *Zona estrecha (pliegues nasolabiales, nariz, barbilla, frente, ceño, lagrimal, pómulo).<br>*Zona ancha (mejilla, sien, etc.).</td>
                          <td>Principalmente para zonas estrechas (pliegues nasolabiales, nariz, barbilla, frente, entrecejo, lagrimal, malar).</td>
                          <td>Principalmente para zonas amplias (mejilla, toda la cara incluyendo la sien).</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="vertical-align: middle;" class="info-coolite">Más del 80% se mantiene durante 25 meses. Después de 3-4 inyecciones iniciales, no hay necesidad de inyecciones adicionales durante 2-3 años.</td>
                          <td>Desaparece durante 6-8 meses y debe repetirse el tratamiento.</td>
                          <td>Desaparece rápidamente después de aproximadamente un mes.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="vertical-align: middle;" class="info-coolite">Necrosis(+), ceguera(+), edema(+).</td>
                          <td>Necrosis(+), ceguera(+), edema(+).</td>
                          <td>Edema(++), hematoma(++).</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="vertical-align: middle;" class="info-coolite">Estimula la generación de colágeno (+++).</td>
                          <td>Induce la generación de colágeno(-).</td>
                          <td>Induce la generación de colágeno(-).</td>
                        </tr>
                      </tbody>
      ...
      <section id="" class="section bg-olidia-one">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center color-white mb-4">Regenera colágeno perdido con el estimulador de colágeno <strong>Olidia</strong></h3>
            </div>
          </div>
          <div class="container">
          <div class="row mt-2">
            <div class="col-md-12">
              <p class="text-center color-white destacado">PLA (Ácido Poli-L-Láctico) es un material que ha sido aprobado por la FDA de EE.UU.<br>Después de la inyección, el PLA es metabolizado y permanece durante cierto tiempo, luego se descompone en H<sub>2</sub>O, CO<sub>2</sub> y azúcar.<br>El PLA (Ácido Poli-L-Láctico) es un polímero de ácido láctico afiliado que existe naturalmente en el cuerpo humano, pero que disminuye con el paso del tiempo.</p>
            </div>
          </div>
        </div>
          <div class="row">
            <div class="col-md-8 offset-md-2 text-center ">
              <figure>
                <img src="assets/img/products/olidia/olidia-regeneracion-colageno.png" alt="Regeneración de colágeno con olidia" class="img-fluid">
              </figure>
            </div>
      ...
      <section id="ultra-delgado" class="section">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <p class="text-center color-dark destacado">Olidia puede combinarse para garantizar una total corrección y suavidad en la piel.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 col-12">
              ...
              <figure class="text-center grafica">
                <img src="assets/img/products/olidia/olidia-metabolismo.png" alt="Metabolismo Olidia" class="img-fluid">
              </figure>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="destacado">Con <strong>Olidia</strong> obtendrás los mejores resultados en Volumen facial y corporal.</p>
            </div>
          </div>
          <!--.row-->
          <div class="row">
                ...
                <li>
                  <div class="row">
                      ...
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-01.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-01.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 col-12 no-mobile">
                      <p><strong>Volumen con Olidia</strong><br><!-- <strong>Observaciones: </strong> --></p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-03.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia después de un año">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-03.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-05.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia despues de un año">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-05.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-07.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-07.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-02.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-02.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-04.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-04.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-06.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-06.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/olidia/olidia-caso-08.jpg" data-lightbox="gallery" data-title="Tratamiento Olidia">
                              <img src="assets/img/casos-clinicos/olidia/thumbs/olidia-caso-thumb-08.jpg" alt="Tratamiento Olidia" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
