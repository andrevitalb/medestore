...
<head>
  ...
  <meta content='https://www.medestore.mx/assets/img/facebook-thumbnails/velux-facebook.png' property='og:image' />
  ...
  <meta name="twitter:description" content="El nuevo equipo con tecnología de láser diodo con doble longitud de onda.">
  <meta name="twitter:image" content="https://www.medestore.mx/assets/img/facebook-thumbnails/velux-facebook.png">
  <title>Medestore | VeLux</title>
  <meta name="description" content="El nuevo equipo con tecnología de láser diodo con doble longitud de onda.">
    ...
    <div id="wrapper">
                ...
                <div class="son-div">
                  <span class="center-block mb-2 mt-2 animated zoomInDown animation-delay-7">
                    <figure class="logo-product">
                      <img src="assets/img/products/velux/logo-velux-white.png" alt="Logotipo de Velux" class="img-fluid">
                    </figure>
                  </span>
                  <h2 id="LIPO1060-title" class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7"><strong class="color-primary-velux">Láser Diodo</strong> con <br><strong class="color-secondary-velux">Doble Longitud de Onda</strong></h2>
              ...
              <div class="col-md-6">
                <div class="center-block mt-2 animated zoomInDown animation-delay-8">
                  <figure class="stage-product">
                    <img src="assets/img/products/velux/velux-stage.png" alt="Equipo VeLux" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
      ...
      <div id="introduccion" class="container mt-3 section">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p class="text-center color-text-lipo1060 destacado"><strong>VeLux</strong> crea la solución para una óptima depilación permanente al combinar dos efectivas longitudes de onda láser de 755nm & 808nm basado en la tecnología de escaneo en movimiento. Las dos longitudes de onda láser trabajan de manera simultánea y su energía concentrada remueve el vello no deseado escaneando a través de un rayo láser directo al folículo piloso con un dolor mínimo.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="center-block mt-2 animated zoomInDown text-center animation-delay-9">
              <figure>
                <img src="assets/img/products/velux/handpiece-velux.png" alt="Pieza de mano de VeLux" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div id="full-ultracel" class="col-md-4 text-center">
              <figure class="">
                <img src="assets/img/products/velux/velux-equipo-full.png" alt="Equipo Velux" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-8 father-div">
              <div class="son-div">
                <h3 class="text-dark mb-2 fadeInDown animation-delay-5">¿Por qué <span class="color-primary-velux">Velux?</h3>
                <h6 class="color-secondary-velux">1. Tecnología de escaneo en movimiento</h6>
                <p class="text-dark">Esta tecnología permite una depilación rápida y efectiva en una área grande sin riesgo a efectos secundarios.</p>
                <h6 class="color-secondary-velux">2. Tamaño de punto variable</h6>
                <p class="text-dark">El tamaño es ajustable de 50 a 10mm, lo que permite una depilación segura y efectiva tanto en el rostro como cualquier parte del cuerpo.</p>
                <h6 class="color-secondary-velux">3. Enfriamiento por contacto y por aire</h6>
                <p class="text-dark">Permite una depilación cómoda hasta en pieles, sin la necesidad de usar anestésicos o geles.</p>
                <h6 class="color-secondary-velux">4. Operación segura, no invasiva.</h6>
                <p class="text-dark">Gracias a la combinación de sus tecnologías permite tratamientos cómodos, seguros y rápidos.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div id="aplicaciones" class="col-md-6">
              <div id="aplica-facial-info">
                <h3 class="text-center color-secondary-velux text-light mb-2 fadeInDown animation-delay-5">DEPILACIÓN FACIAL Y CORPORAL</h3>
                <ul class="facial-list">
                  <li>Elimina cualquier tipo de vello.</li>
                  <li>Seguro y con menos sesiones que otros tratamientos.</li>
                  <li>Gran eficacia en superficies pequeñas del rostro o superficies grandes del cuerpo.</li>
            ...
            <div id="aplicacion-facial" class="col-md-6">
              <figure>
                <img src="assets/img/products/velux/aplicacion-corporal-velux.png" alt="Resultados de la aplicación corporal de VeLux" class="img-fluid">
              </figure>
            </div>
          </div>
        </div>
      ...
      <section id="" class="section ms-hero-img-room color-white intro-hero-full bg-velux-one">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-center color-sub-lipo1060 text-light mb-2 fadeInDown animation-delay-5">Tecnología de escaneo en movimiento</h2>
              <h3 class="text-center color-secondary-velux text-light mb-2 fadeInDown animation-delay-5">Alta fluidez en pulsos de corta duración hasta 3ms</h3>
              <p class="text-center color-text-lipo1060 destacado">La tecnología de escaneo en movimiento es un método revolucionario para el tratamiento de depilación rápida del vello  escaneando eficazmente un área grande de 50 por 15 mm en aproximadamente 0,5-1,5 segundos. Además, ofrece una alta densidad de potencia de 2.400 vatios/cm2 y permite suministrar una alta fluencia con una duración de pulso corta de hasta 3 ms para el vello fino y brillante sin riesgo de efectos secundarios.</p>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-6 col-12">
              <figure class="text-center tecno-vacuum">
                <img src="assets/img/products/velux/target-velux.jpg" alt="Tecnología de VeLux" class="img-fluid">
              </figure>
            </div>
            <div class="col-md-6 col-12">
              <figure class="text-center tecno-vacuum">
                <img src="assets/img/products/velux/lines-velux.jpg" alt="Depilación con VeLux" class="img-fluid">
              </figure>
            </div>
          </div>
      ...
      <section id="" class="section bg-velux-two">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-3 ">
              <figure>
                <img src="assets/img/products/velux/etapa-enfriamiento-velux.jpg" alt="Sistema de enfriamiento de VeLux" class="img-fluid">
              </figure>
              <!-- <h6 class="color-primary-ultracel_q text-center">Fase de inflamación</h6> -->
              <p class="text-center color-white mt-2">La piel se enfría antes y durante el tratamiento.</p>
            </div>
            <div class="col-md-3 ">
              <figure>
                <img src="assets/img/products/velux/etapa-ondas_dobles-velux.jpg" alt="Smart Target Motion de VeLux" class="img-fluid">
              </figure>

              <p class="text-center color-white mt-2">Las ondas dobles se concentran en un solo rayo láser que escanea y llega al folículo piloso.(Smart Target Motion)</p>
            </div>
            <div class="col-md-3 ">
              <figure>
                <img src="assets/img/products/velux/etapa-eritema-velux.jpg" alt="Zona tratada con VeLux" class="img-fluid">
              </figure>

              <p class="text-center color-white mt-2">Puede aparecer un leve eritema y edema en las zonas tratadas.</p>
            </div>
            <div class="col-md-3 ">
              <figure>
                <img src="assets/img/products/velux/etapa-vello_desaparece-velux.jpg" alt="Depilación efectiva con VeLux " class="img-fluid">
              </figure>

              <p class="text-center color-white mt-2">El vello comenzará a desaparecer de forma natural.</p>
            </div>
          </div>
        </div>
        <div class="container">
          <div class="row mt-2">
            <div class="col-md-12">
              <p class="text-center color-white destacado">La tecnología <strong>Smart Target Motion</strong> suministrará la energía en 5 zonas diferentes en orden aleatorio y hará que el tratamiento sea prácticamente indoloro y bastante tolerable durante el proceso.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="ultra-delgado" class="section">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center mb-4">Ventajas de <strong class="color-primary-velux">VeLux</strong></h3>
          ...
          <div class="row">
            <div class="col-md-4 col-12">
              ...
              <figure class="text-center grafica">
                <img src="assets/img/products/velux/flexibilidad-VeLux.png" alt="Alta velocidad y flexibilidad de VeLux" class="img-fluid">
              </figure>
              <p class="text-center mt-2">El gran tamaño del punto ofrecerá un tratamiento rápido del vello gracias a su tecnología de escaneo en movimiento. Su tamaño de escaneo es ajustable de 50 a 10 mm para una aplicación fácil y sencilla dirigida a pequeñas áreas de la cara y el cuerpo. Además, la exclusiva y magnética punta facial conectable  hace que sea más fácil y cómodo llegar a zonas estrechas de 10 por 15 mm para obtener un resultado excelente.</p>
            ...
            <div class="col-md-4 col-12">
              ...
              <figure class="text-center grafica">
                <img src="assets/img/products/velux/Doble-Longitud-de-onda-grafica-velux.png" alt="Doble longitud de onda de VeLux" class="img-fluid">
              </figure>
              <p class="text-center mt-2">Al aprovechar todas las ventajas de la penetración profunda y la alta tasa de absorción de energía de 2 longitudes de onda diferentes de láser de 808 y 755nm, VeLux775 será capaz de ofrecer una amplia gama de cobertura de tratamiento seguro para todos los tipos de piel y vello, incluso los de color claro y vello fino</p>
            </div>
            <div class="col-md-4 col-12">
              <h5 class="text-center color-secondary-velux">Potente refrigeración y comodidad</h5>
              
              <figure class="text-center grafica">
                <img src="assets/img/products/velux/enfriamiento-VeLux.png" alt="Enfrimiento de VeLux" class="img-fluid">
              </figure>
              <p class="text-center mt-2">La combinación de la potente tecnología de enfriamiento por contacto de la punta de zafiro y la tecnología de escaneo de movimiento proporciona el beneficio óptimo del tratamiento de depilación sin anestésicos ni geles en comparación con su sistema de láser de depilación de diodo convencional. Además, el profesional puede elegir un adaptador de refrigeración por aire adicional para el vello fino o la piel sensible, que ofrece una mayor comodidad durante el tratamiento.</p>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="destacado">Con <strong>VeLux</strong> lograrás los mejores resultados en depilación mediante un tratamiento seguro, cómodo y efectivo para tus pacientes.</p>
            </div>
          </div>
          <!--.row-->
          <div class="row">
                ...
                <li>
                  <div class="row">
                      ...
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-01.jpg" data-lightbox="gallery" data-title="Depilación en brazo con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-01-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 col-12 no-mobile">
                      <p><strong>Fototipo IV | Femenino | 29 años</strong><br><strong>Observaciones: </strong>Resultados en 6 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-03.jpg" data-lightbox="gallery" data-title="Depilación en pectoral con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-03-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo III | Masculino | 40 años</strong><br><strong>Observaciones: </strong>Resultados en 6 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-05.jpg" data-lightbox="gallery" data-title="Depilación en piernas con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-05-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo IV | Femenino | 29 años</strong><br><strong>Observaciones: </strong>Resultados en 3 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-07.jpg" data-lightbox="gallery" data-title="Depilación en brazos con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-07-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo IV | Femenino | 50 años</strong><br><strong>Observaciones: </strong>Resultados en 4 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-09.jpg" data-lightbox="gallery" data-title="Depilación en brazos con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-09-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo IV | Femenino | 27 años</strong><br><strong>Observaciones: </strong>Resultados en 4 sesiones</p>
                    </div>
                  </div>
                </li>
              </ul>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-02.jpg" data-lightbox="gallery" data-title="Depilación en piernas con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-02-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo IV | Masculino | 32 años</strong><br><strong>Observaciones: </strong>Resultados en 6 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-04.jpg" data-lightbox="gallery" data-title="Depilación en brazos con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-04-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo IV | Femenino | 38 años</strong><br><strong>Observaciones: </strong>Resultados en 3 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-06.jpg" data-lightbox="gallery" data-title="Depilación en brazos con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-06-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo IV | Femenino | 21 años</strong><br><strong>Observaciones: </strong>Resultados en 3 sesiones</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-08.jpg" data-lightbox="gallery" data-title="Depilación en brazos con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-08-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo II | Femenino | 23 años</strong><br><strong>Observaciones: </strong>Resultados en 1 sesión</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <div class="card">
                        <div class="card-block p-05">
                          <div class="withripple ">
                            <a href="assets/img/casos-clinicos/velux/Velux_Casos-10.jpg" data-lightbox="gallery" data-title="Depilación en piernas con VeLux">
                              <img src="assets/img/casos-clinicos/velux/Velux_Casos-10-thumb.jpg" alt="Depilación con VeLux" class="img-fluid">
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-8 no-mobile">
                      <p><strong>Fototipo III | Masculino | 27 años</strong><br><strong>Observaciones: </strong>Resultados en 3 sesines</p>
                    </div>
                  </div>
                </li>
              </ul>
          ...
          <div class="row">
            <div class="col-md-7 col-12">
              <div class="title-data-sheet">
                ...
                <!-- <div class="col-6"> -->
                <figure class="logo-product">
                  <img src="assets/img/products/velux/logo-velux-color.png" alt="Logotipo de LIPO1060" class="img-fluid">
                </figure>
                <!-- </div> -->
                <!-- <div class="col-6"> -->
              ...
              <div class="download-brochure">
                <a href="assets/brochures/brochure-VeLux.pdf" class="btn btn-raised btn-primary btn-brochure" target="_blank">DESCARGAR FOLLETO</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-6 mt-6">
              ...
              <form id="form-equipo-velux" method="post" action="contact-equipment.php" class="container-fluid contactEqpmnt">
    ...
    <div class="sb-slidebar-container">
      ...
      <div class="ms-slidebar-social ms-slidebar-block">
        ...
        <div class="ms-slidebar-social">
            ...
            <a href="https://twitter.com/Medestoremx" class="btn-circle btn-circle-raised btn-twitter">
